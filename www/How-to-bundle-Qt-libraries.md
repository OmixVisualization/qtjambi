...
- `qt-lib-core-native-windows-x64-6.4.3.jar`
- `qt-lib-gui-native-windows-x64-6.4.3.jar`
- `qt-lib-qml-native-windows-x64-6.4.3.jar`
- ...
...
Possible arguments are:
  ...
  - `--qtdir=...` path to *Qt* version, e.g. `C:\Qt\6.4.3\msvc2019_64`
