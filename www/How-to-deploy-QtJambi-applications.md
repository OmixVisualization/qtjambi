...
depending on `qtjambi-6.5.7.jar`.
...
installation directory
    ...
    | lib
        | qtjambi-6.5.7.jar
        | qtjambi-native-windows-x64-6.5.7.jar
        | my-company-app.jar
    | jre
...
java -Djava.library.path=<path to Qt libraries>
     ...
     --class-path=../lib/my-company-app.jar:../lib/qtjambi-6.5.7.jar:../lib/qtjambi-native-windows-x64-6.5.7.jar
     --library-path=.
     --jvm-path=../jre
...
installation directory
    ...
    | lib
        ...
        | qtjambi-6.5.7.jar
        | qtjambi-native-linux-x64-6.5.7.jar
        | my-company-app.jar
    | jre
        | ... (Java Runtime Environment)
```
...
java -Djava.library.path=<path to Qt libraries>
     ...
     --class-path=lib/my-company-app.jar:lib/qtjambi-6.5.7.jar:lib/qtjambi-native-linux-x64-6.5.7.jar
     --library-path=lib
     --jvm-path=jre
     --main-class=my.company.app.Main
     --dir=output directory (may be installation directory)
    ...
    | MyCompanyApp.app
        |Contents
            ...
            | Frameworks
             ...
             | lib
                | qtjambi-6.5.7.jar
                | qtjambi-native-macos-6.5.7.jar
                | my-company-app.jar
            | jre
                | ... (Java Runtime Environment)
            | Resources
...
java -Djava.library.path=<path to Qt libraries>
     ...
     --class-path=../lib/my-company-app.jar:../lib/qtjambi-6.5.7.jar:../lib/qtjambi-native-macos-6.5.7.jar
