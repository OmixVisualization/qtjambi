...
[![Maven Central](https://maven-badges.sml.io/sonatype-central/io.qtjambi/qtjambi/badge.svg?version=6.10.2)](https://central.sonatype.com/artifact/io.qtjambi/qtjambi/6.10.2)
...
```
Here, exchange `$VERSION` either by `6.8.8`, `6.10.2` or any other published version. Exchange `$MODULE` by *QtJambi* module name as listed below.
...
QtJambi 6.10.2 requires Qt 6.10.x whereas x can be any patch version greater or equals 0.
This release has been built with Qt 6.10.2. Compatibility to higher versions is unknown.
...
* [QtCore](https://doc.qt.io/qt-6/qtcore-index.html), [QtGui](https://doc.qt.io/qt-6/qtgui-index.html) and [QtWidgets](https://doc.qt.io/qt-6/qtwidgets-index.html) in module **qtjambi**:
    * [**qtjambi-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi/6.10.2/jar)
    * [**qtjambi-native-windows-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-windows-x64/6.10.2/jar)
    * [**qtjambi-debuginfo-windows-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-debuginfo-windows-x64/6.10.2/jar)
    * [**qtjambi-native-windows-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-windows-arm64/6.10.2/jar)
    * [**qtjambi-debuginfo-windows-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-debuginfo-windows-arm64/6.10.2/jar)
    * [**qtjambi-native-linux-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-linux-x64/6.10.2/jar)
    * [**qtjambi-debuginfo-linux-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-debuginfo-linux-x64/6.10.2/jar)
    * [**qtjambi-native-linux-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-linux-arm64/6.10.2/jar)
    * [**qtjambi-debuginfo-linux-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-debuginfo-linux-arm64/6.10.2/jar)
    * [**qtjambi-native-macos-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-macos/6.10.2/jar)
    * [**qtjambi-debuginfo-macos-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-debuginfo-macos/6.10.2/jar)
    * [**qtjambi-native-android-x86-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-android-x86/6.10.2/jar)
    * [**qtjambi-native-android-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-android-x64/6.10.2/jar)
    * [**qtjambi-native-android-arm-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-android-arm/6.10.2/jar)
    * [**qtjambi-native-android-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-native-android-arm64/6.10.2/jar)
...
* JDBC Sql Plugin:
    * [**qtjambi-plugin-qsqljdbc-windows-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-windows-x64/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-windows-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-windows-arm64/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-linux-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-linux-x64/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-linux-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-linux-arm64/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-macos-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-macos/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-native-android-common-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-native-android-common/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-native-android-x86-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-native-android-x86/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-native-android-x64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-native-android-x64/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-native-android-arm-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-native-android-arm/6.10.2/jar)
    * [**qtjambi-plugin-qsqljdbc-native-android-arm64-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-plugin-qsqljdbc-native-android-arm64/6.10.2/jar)

## QtJambi Tools

* [QtJambi User Interface Compiler (UIC)](https://doc.qt.io/qt-6/designer-using-a-ui-file.html#compile-time-form-processing):
    * [**qtjambi-uic-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-uic/6.10.2/jar)
    * patform bundles for **Windows**, **Linux** and **macOS**
* QtJambi Deployer:
    * [**qtjambi-deployer-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-deployer/6.10.2/jar)
    * patform bundles for **Windows**, **Linux**, **macOS** and **Android**
* QtJambi Generator:
    * [**qtjambi-generator-6.10.2.jar**](https://search.maven.org/artifact/io.qtjambi/qtjambi-generator/6.10.2/jar)
    * patform bundles for **Windows**, **Linux** and **macOS**
