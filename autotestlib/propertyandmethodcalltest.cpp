...
bool PropertyAndMethodCallTest::connectSignals(QObject* sender, bool useAnnotatedType){
    bool connected = true;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    connected &= bool(QtJambi::connect(sender, SIGNAL(customEnumChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::CustomEnum)), this, SLOT(receiveCustomEnum(JEnumWrapper))));
    connected &= bool(QtJambi::connect(sender, SIGNAL(customQtEnumChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::CustomQtEnum)), this, SLOT(receiveCustomQtEnum(JEnumWrapper))));
    connected &= bool(QtJambi::connect(sender, SIGNAL(customQtFlagsChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::CustomQtFlags)), this, SLOT(receiveQtFlags(JObjectWrapper))));
    ...
    connected &= bool(QtJambi::connect(sender, SIGNAL(customQtValueChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::CustomQtValue*)), this, SLOT(receiveCustomQtValue(QGraphicsItem*))));
    connected &= bool(QtJambi::connect(sender, SIGNAL(customQtInterfaceValueChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::CustomQtInterfaceValue*)), this, SLOT(receiveCustomQtInterfaceValue(QGraphicsItem*))));
    connected &= bool(QtJambi::connect(sender, SIGNAL(customJavaTypeChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::CustomJavaType*)), this, SLOT(receiveCustomJavaType(JObjectWrapper))));
    connected &= bool(QtJambi::connect(sender, SIGNAL(derivedQObjectChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::DerivedQObject*)), this, SLOT(receiveDerivedQObject(QObject*))));
    connected &= bool(QtJambi::connect(sender, SIGNAL(extendedColorChanged(io::qt::autotests::TestPropertyAndMethodCall::TestQObject::ExtendedColor)), this, SLOT(receiveExtendedColor(JObjectWrapper))));
#else
