...
class AbstractMetaObjectTools {
    ...
    static int metaTypeIdForName(String name) {
    ...
    static MetaObjectTools.QPropertyTypeInfo getQPropertyTypeInfo(Field field) {
    	if(field.getType()==QObject.QBooleanProperty.class
    		...
    		return new MetaObjectTools.QPropertyTypeInfo(boolean.class, boolean.class, false, false, field.getType()==QObject.QBooleanProperty.class);
    	}else if(field.getType()==QObject.QByteProperty.class
    			|| field.getType()==QObject.QComputedByteProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(byte.class, byte.class, false, false, field.getType()==QObject.QByteProperty.class);
    	}else if(field.getType()==QObject.QIntProperty.class
    			|| field.getType()==QObject.QComputedIntProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(int.class, int.class, false, false, field.getType()==QObject.QIntProperty.class);
    	}else if(field.getType()==QObject.QShortProperty.class
    			|| field.getType()==QObject.QComputedShortProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(short.class, short.class, false, false, field.getType()==QObject.QShortProperty.class);
    	}else if(field.getType()==QObject.QLongProperty.class
    			|| field.getType()==QObject.QComputedLongProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(long.class, long.class, false, false, field.getType()==QObject.QLongProperty.class);
    	}else if(field.getType()==QObject.QFloatProperty.class
    			|| field.getType()==QObject.QComputedFloatProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(float.class, float.class, false, false, field.getType()==QObject.QFloatProperty.class);
    	}else if(field.getType()==QObject.QDoubleProperty.class
    			|| field.getType()==QObject.QComputedDoubleProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(double.class, double.class, false, false, field.getType()==QObject.QDoubleProperty.class);
    	}else if(field.getType()==QObject.QCharProperty.class
    			|| field.getType()==QObject.QComputedCharProperty.class) {
    		return new MetaObjectTools.QPropertyTypeInfo(char.class, char.class, false, false, field.getType()==QObject.QCharProperty.class);
        	...
        	if (t instanceof AnnotatedParameterizedType) {
            	...
            	if(actualTypes.length==1) {
                    ...
                    return new MetaObjectTools.QPropertyTypeInfo(rawType, type, isPointer, isReference, field.getType()==QObject.QProperty.class);
            	}
        	}
    	}
    	return null;
    ...
    static void registerPropertyField(QMetaProperty metaProperty, java.lang.reflect.Field field) {
    	registerPropertyField(QtJambiInternal.nativeId(metaProperty), field);
    }
