...
public final class QPropertyAlias<T> extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public T value() {
        return QBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()), 0);
    }
	...
	public void setValue(T newValue) {
		QBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), 0, newValue);
    }
