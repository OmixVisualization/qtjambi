...
public final class QBytePropertyAlias extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public byte value() {
        return QByteBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(byte newValue) {
		QByteBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
