...
public final class QDoublePropertyAlias extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public double value() {
        return QDoubleBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(double newValue) {
		QDoubleBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
