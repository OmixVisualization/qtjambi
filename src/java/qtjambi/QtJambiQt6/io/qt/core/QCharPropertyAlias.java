...
public final class QCharPropertyAlias extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public char value() {
        return QCharBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(char newValue) {
		QCharBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
