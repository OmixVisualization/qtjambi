...
public final class QLongPropertyAlias extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public long value() {
        return QLongBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(long newValue) {
		QLongBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
