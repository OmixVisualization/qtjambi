...
public final class QFloatPropertyAlias extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public float value() {
        return QFloatBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(float newValue) {
		QFloatBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
