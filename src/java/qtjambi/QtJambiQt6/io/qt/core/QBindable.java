...
public final class QBindable<T> extends QUntypedBindable {
	...
	public QBindable(QProperty<T> property) {
		super(property.valueMetaType().isValid() ? property : null, property.valueMetaType().isValid() ? bindableInterface(property.valueMetaType().id(), 0) : null, true);
	}
	...
	public QBindable(QObject.QProperty<T> property) {
		super(property.valueMetaType().isValid() ? property : null, property.valueMetaType().isValid() ? bindableInterface(property.valueMetaType().id(), 1) : null, true);
	}
	...
	public QBindable(QObject.QComputedProperty<T> property) {
		super(property.valueMetaType().isValid() ? property : null, property.valueMetaType().isValid() ? bindableInterface(property.valueMetaType().id(), 2) : null, true);
	}
	...
	public QBindable(QPropertyAlias<T> property) {
		super(property.aliasedProperty(), property.iface, true);
	}
    ...
    public final T value() {
		return value(nativeId(this.iface()), nativeId(this.data()), 0);
	}
    ...
    public final void setValue(T value) {
		setValue(nativeId(this.iface()), nativeId(this.data()), 0, value);
	}
