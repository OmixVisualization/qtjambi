...
public final class QShortPropertyAlias extends QAbstractPropertyAlias {
	...
	@QtUninvokable
	public short value() {
        return QShortBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(short newValue) {
		QShortBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
