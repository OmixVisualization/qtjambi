...
public final class QBooleanPropertyAlias extends QAbstractPropertyAlias {
	...
	public boolean value() {
        return QBooleanBindable.value(nativeId(this.iface), nativeId(this.aliasedProperty()));
    }
	...
	public void setValue(boolean newValue) {
		QBooleanBindable.setValue(nativeId(this.iface), nativeId(this.aliasedProperty()), newValue);
    }
