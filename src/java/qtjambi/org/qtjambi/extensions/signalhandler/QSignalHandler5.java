 ...
 * connections.
 */
public abstract class QSignalHandler5<A, B, C, D, E> {

    /**
     * Creates a new signal handler that sets up a connection from the input signal to this object.
     * @param signal The signal to connect to.
     */
    public QSignalHandler5(QSignalEmitter.Signal5<A, B, C, D, E> signal) {
        signal.connect(this, "handle(Object, Object, Object, Object, Object)");
    }
    ...
    */
    public abstract void handle(A arg1, B arg2, C arg3, D arg4, E arg5);
}
