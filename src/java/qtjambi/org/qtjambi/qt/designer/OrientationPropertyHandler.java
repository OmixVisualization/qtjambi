...
class OrientationPropertyHandler extends AbstractPropertyHandler {
    public Object create(QDomElement e) throws QUiLoaderException {
        ...
        if (orientation.contains("Vertical")) {
            return org.qtjambi.qt.core.Qt.Orientation.Vertical;
        } else {
            return org.qtjambi.qt.core.Qt.Orientation.Horizontal;
        }
    }
}
