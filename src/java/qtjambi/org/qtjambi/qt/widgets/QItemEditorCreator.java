...
public class QItemEditorCreator extends QItemEditorCreatorBase {
    ...
    public QItemEditorCreator(String valuePropertyName, Class<? extends QWidget> widgetType) {
        ...
        try {
            ...
            createWidgetOverride = org.qtjambi.qt.internal.QtJambiInternal.isImplementedInJava(createWidgetMethod);
            valuePropertyNameOverride = org.qtjambi.qt.internal.QtJambiInternal.isImplementedInJava(valuePropertyNameMethod);
        } catch (Throwable t) {
