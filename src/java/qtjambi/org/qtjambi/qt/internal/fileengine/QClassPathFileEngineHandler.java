...
// FIXME: This should be protected API (candiate to move org/qtjambi/qt/native/internal).
public class QClassPathFileEngineHandler
{
    ...
    // FIXME This is only public so org/qtjambi/qt/QtJambi_LibraryShutdown.java can see it
