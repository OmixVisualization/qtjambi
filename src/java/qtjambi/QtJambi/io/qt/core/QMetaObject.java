...
public final class QMetaObject {
    ...
    public enum Call implements QtEnumerator{
        ...
        public static Call resolve(int value) {
            ...
            case 4: 
                ...
                else return resolveEnum(Call.class, value, "QueryPropertyDesignable");
            case 5: 
                if(QtJambiInternal.majorVersion()>5)
                    return IndexOfMethod;
                else return resolveEnum(Call.class, value, "QueryPropertyScriptable");
            case 6: 
                if(QtJambiInternal.majorVersion()>5)
                    return RegisterPropertyMetaType;
                else return resolveEnum(Call.class, value, "QueryPropertyStored");
            case 7: 
                if(QtJambiInternal.majorVersion()>5)
                    return RegisterMethodArgumentMetaType;
                else return resolveEnum(Call.class, value, "QueryPropertyEditable");
            case 8:
                if(QtJambiInternal.majorVersion()>5)
                    return resolveEnum(Call.class, value, "RegisterQPropertyObserver");
                else return resolveEnum(Call.class, value, "QueryPropertyUser");
            case 9: 
                if(QtJambiInternal.majorVersion()>5)
                    return resolveEnum(Call.class, value, "SetQPropertyBinding");
    ...
    private final static class SignalAccess extends QtJambiSignals {
        ...
        static void _emitNativeSignal(long senderNativeId, int methodIndex, Object args[]) {
        	QtJambiSignals.emitNativeSignal(senderNativeId, methodIndex, args);
        }
    ...
    public static abstract class AbstractSignal extends SignalAccess.AbstractSignal {
		...
		static void emitNativeSignal(long senderNativeId, int methodIndex, Object... args) {
			SignalAccess._emitNativeSignal(senderNativeId, methodIndex, args);
		}
    }
    ...
    private static AbstractSignal findSignalImpl(QObject sender, String name, Class<?>... types){
    	QtJambiInternal.checkedNativeId(Objects.requireNonNull(sender));
    ...
    private int enumeratorIndex(QMetaEnum metaEnum) {
        return enumeratorIndex(metaObjectPointer, nativeId(metaEnum));
    }
