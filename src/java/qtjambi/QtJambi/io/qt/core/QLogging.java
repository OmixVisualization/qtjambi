...
public final class QLogging {
    ...
    @QtUninvokable
    private static Supplier format(String message, Object...args) {
    ...
    public static void qCWarning(QLoggingCategory category, String message) {
    	showCMessage(QtMsgType.QtWarningMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
    ...
    public static void qCWarning(QLoggingCategory category, String message, Object...args) {
    	qCWarning(category, format(message, args));
    }
    ...
    public static void qCDebug(QLoggingCategory category, String message) {
    	showCMessage(QtMsgType.QtDebugMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
    ...
    public static void qCDebug(QLoggingCategory category, String message, Object...args) {
    	qCDebug(category, format(message, args));
    }
    ...
    public static void qCInfo(QLoggingCategory category, String message) {
    	showCMessage(QtMsgType.QtInfoMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
    ...
    public static void qCInfo(QLoggingCategory category, String message, Object...args) {
    	qCInfo(category, format(message, args));
    }
    ...
    public static void qCCritical(QLoggingCategory category, String message) {
    	showCMessage(QtMsgType.QtCriticalMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
    ...
    public static void qCCritical(QLoggingCategory category, String message, Object...args) {
    	qCCritical(category, format(message, args));
    }
     ...
     */
    @QtUninvokable
    public static void qWarning(Supplier message) {
     ...
     */
    @QtUninvokable
    public static void qDebug(Supplier message) {
     ...
     */
    @QtUninvokable
    public static void qInfo(Supplier message) {
     ...
     */
    @QtUninvokable
    public static void qCritical(Supplier message) {
     ...
     */
    @QtUninvokable
    public static void qFatal(Supplier message) {
     ...
     */
    @QtUninvokable
    public static void qCWarning(QLoggingCategory category, Supplier message) {
    	showCMessageFromSupplier(QtMsgType.QtWarningMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
     ...
     */
    @QtUninvokable
    public static void qCDebug(QLoggingCategory category, Supplier message) {
    	showCMessageFromSupplier(QtMsgType.QtDebugMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
     ...
     */
    @QtUninvokable
    public static void qCInfo(QLoggingCategory category, Supplier message) {
    	showCMessageFromSupplier(QtMsgType.QtInfoMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
     ...
     */
    @QtUninvokable
    public static void qCCritical(QLoggingCategory category, Supplier message) {
    	showCMessageFromSupplier(QtMsgType.QtCriticalMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)), message);
    }
    ...
    public static QDebug qCWarning(QLoggingCategory category) {
    	return getCDebug(QtMsgType.QtWarningMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)));
    }
    ...
    public static QDebug qCDebug(QLoggingCategory category) {
    	return getCDebug(QtMsgType.QtDebugMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)));
    }
    ...
    public static QDebug qCInfo(QLoggingCategory category) {
    	return getCDebug(QtMsgType.QtInfoMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)));
    }
    ...
    public static QDebug qCCritical(QLoggingCategory category) {
    	return getCDebug(QtMsgType.QtCriticalMsg.value(), QtJambiInternal.checkedNativeId(Objects.requireNonNull(category)));
    }
    ...
    @QtUninvokable
    private native static void showMessageFromSupplier(int messageType, Supplier message);
    
    @QtUninvokable
    private native static void showCMessage(int messageType, long categoryId, String message);
    @QtUninvokable
    private native static void showCMessageFromSupplier(int messageType, long categoryId, Supplier message);
}
