...
public class QLinkedList<T> extends io.qt.internal.QtJambiCollectionObject<T> implements Deque<T>, Cloneable
{
    ...
    public final void append(T t)    {
		try {
			__qt_QLinkedList_append(nativeId(this), t);
    ...
    protected final QIterator<T> begin()    {
        return __qt_QLinkedList_begin(nativeId(this));
    }
    @QtUninvokable
    ...
    public final void clear()    {
        __qt_QLinkedList_clear(nativeId(this));
    }
    @QtUninvokable
    ...
    public final boolean contains(Object t)    {
        try{
        	return __qt_QLinkedList_contains(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    ...
    public final int count(T t)    {
        try{
        	return __qt_QLinkedList_count(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    protected final QIterator<T> end()    {
        return __qt_QLinkedList_end(nativeId(this));
    }
    @QtUninvokable
    ...
    public final boolean endsWith(T t)    {
        try{
        	return __qt_QLinkedList_endsWith(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final T first()    {
        ...
        return __qt_QLinkedList_first(nativeId(this));
    }
    @QtUninvokable
    ...
    public final T last()    {
		if(size()==0)
			throw new NoSuchElementException();
        return __qt_QLinkedList_last(nativeId(this));
    }
    @QtUninvokable
    ...
    private final boolean operator_equal(java.util.Collection<T> l)    {
        return __qt_QLinkedList_operator_equal(nativeId(this), l);
    }
    @QtUninvokable
    ...
    public final void prepend(T t)    {
        try{
        	__qt_QLinkedList_prepend(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final int removeAll(T t)    {
    	try {
    		return __qt_QLinkedList_removeAll(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(IllegalArgumentException e) {
    		return 0;
    ...
    public final T removeFirst()    {
    	T value = first();
        __qt_QLinkedList_removeFirst(nativeId(this));
        return value;
    }
    @QtUninvokable
    ...
    public final T removeLast()    {
    	T value = last();
        __qt_QLinkedList_removeLast(nativeId(this));
        return value;
    }
    @QtUninvokable
    ...
    public final boolean removeOne(T t)    {
        try{
        	return __qt_QLinkedList_removeOne(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(IllegalArgumentException e) {
    		return false;
    ...
    public final int size()    {
        return __qt_QLinkedList_size(nativeId(this));
    }
    @QtUninvokable
    ...
    public final boolean startsWith(T t)    {
        try{
        	return __qt_QLinkedList_startsWith(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final T takeFirst()    {
        return __qt_QLinkedList_takeFirst(nativeId(this));
    }
    @QtUninvokable
    ...
    public final T takeLast()    {
        return __qt_QLinkedList_takeLast(nativeId(this));
    }
    @QtUninvokable
    ...
    public void writeTo(io.qt.core.QDataStream stream){
        __qt_QLinkedList_writeTo(nativeId(this), nativeId(stream));
    }
    ...
    public void readFrom(io.qt.core.QDataStream stream){
        __qt_QLinkedList_readFrom(nativeId(this), nativeId(stream));
    }
