...
public class QVector<T> extends io.qt.internal.QtJambiListObject<T> implements Cloneable
{
    ...
    public final void append(java.util.Collection<T> t)    {
        __qt_QVector_appendVector(nativeId(this), t);
    }
    @QtUninvokable
    ...
    public final void append(T t)    {
    	try {
    		__qt_QVector_append(nativeId(this), t);
    ...
    public final T at(int i)    {
        ...
        return __qt_QVector_at(nativeId(this), i);
    }
    @QtUninvokable
    ...
    protected final QIterator<T> begin()    {
        return __qt_QVector_begin(nativeId(this));
    }
    @QtUninvokable
    ...
    public final int capacity()    {
        return __qt_QVector_capacity(nativeId(this));
    }
    @QtUninvokable
    ...
    public final void clear()    {
        __qt_QVector_clear(nativeId(this));
    }
    @QtUninvokable
    ...
    public final boolean contains(Object t)    {
        try{
        	return __qt_QVector_contains(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    ...
    public final int count(T t)    {
        try{
        	return __qt_QVector_count(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    protected final QIterator<T> end()    {
        return __qt_QVector_end(nativeId(this));
    }
    @QtUninvokable
    ...
    public final boolean endsWith(T t)    {
        try{
        	return __qt_QVector_endsWith(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final void fill(T t, int size)    {
    	try {
    		__qt_QVector_fill(nativeId(this), t, size);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final int indexOf(T t, int from)    {
    	try {
    		return __qt_QVector_indexOf(nativeId(this), t, from);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(IllegalArgumentException e) {
    		return -1;
    ...
    public final void insert(int i, T t)    {
        ...
        try {
        	__qt_QVector_insert(nativeId(this), i, t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final void insert(int i, int n, T t)    {
        ...
        try {
        	__qt_QVector_insertN(nativeId(this), i, n, t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final int lastIndexOf(T t, int from)    {
    	try {
    		return __qt_QVector_lastIndexOf(nativeId(this), t, from);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(IllegalArgumentException e) {
    		return -1;
    ...
    public final QVector<T> mid(int pos, int length)    {
        ...
        return __qt_QVector_mid(nativeId(this), pos, length);
    }
    @QtUninvokable
    ...
    public final void move(int from, int to)    {
        ...
        __qt_QVector_move(nativeId(this), from, to);
    }
    @QtUninvokable
    ...
    private final boolean operator_equal(java.util.Collection<T> l)    {
        return __qt_QVector_operator_equal(nativeId(this), l);
    }
    @QtUninvokable
    ...
    public final void prepend(T t)    {
    	try {
    		__qt_QVector_prepend(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final void remove(int i, int n)    {
        ...
        __qt_QVector_removeN(nativeId(this), i, n);
    }
    @QtUninvokable
    ...
    public final int removeAll(T t)    {
        try {
        	return __qt_QVector_removeAll(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(IllegalArgumentException e) {
    		return 0;
    ...
    public final void removeAt(int i)    {
        ...
        __qt_QVector_removeAt(nativeId(this), i);
    }
    @QtUninvokable
    ...
    public final boolean removeOne(T t)    {
        try{
        	return __qt_QVector_removeOne(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(IllegalArgumentException e) {
    		return false;
    ...
    public final void replace(int i, T t)    {
        ...
        try {
        	__qt_QVector_replace(nativeId(this), i, t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final void reserve(int size)    {
        __qt_QVector_reserve(nativeId(this), size);
    }
    @QtUninvokable
    ...
    public final void resize(int size)    {
        __qt_QVector_resize(nativeId(this), size);
    }
    @QtUninvokable
    ...
    public final void squeeze()    {
        __qt_QVector_squeeze(nativeId(this));
    }
    @QtUninvokable
    ...
    public final int size()    {
        return __qt_QVector_size(nativeId(this));
    }
    @QtUninvokable
    ...
    public final boolean startsWith(T t)    {
        try{
        	return __qt_QVector_startsWith(nativeId(this), t);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    		throw QSet.handleException(e, elementMetaType(), t);
    ...
    public final T takeAt(int i)    {
        ...
        return __qt_QVector_takeAt(nativeId(this), i);
    }
    @QtUninvokable
    ...
    public final QSet<T> toSet()    {
        return __qt_QVector_toSet(nativeId(this));
    }
    @QtUninvokable
    ...
    public final T value(int i)    {
        return __qt_QVector_value(nativeId(this), i);
    }
    @QtUninvokable
    ...
    public final T value(int i, T defaultValue)    {
    	try {
    		return __qt_QVector_valueDefault(nativeId(this), i, defaultValue);
    	}catch(QNoNativeResourcesException e) {
    		throw e;
    	}catch(RuntimeException e) {
    ...
    public void writeTo(io.qt.core.QDataStream stream){
        __qt_QVector_writeTo(nativeId(this), nativeId(stream));
    }
    ...
    public void readFrom(io.qt.core.QDataStream stream){
        __qt_QVector_readFrom(nativeId(this), nativeId(stream));
    }
