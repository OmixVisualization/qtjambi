...
public class FilterSsl extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategorySsl.class;
	private static final String packageName = "org.qtjambi.qt.network";
	private static final String className = "QSslSocket";
	...
	public FilterSsl(boolean includeFlag) {
		super(includeFlag);
	}
