...
public class FilterScript extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategoryScript.class;
	private static final String packageName = "org.qtjambi.qt.script";
	private static final String className = "QScriptEngine";
	...
	public FilterScript(boolean includeFlag) {
		super(includeFlag);
	}
