...
public class FilterHelp extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategoryHelp.class;
	private static final String packageName = "org.qtjambi.qt.help";
	private static final String className = "QHelpEngine";
	...
	public FilterHelp(boolean includeFlag) {
		super(includeFlag);
	}
