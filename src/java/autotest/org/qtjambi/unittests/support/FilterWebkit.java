...
public class FilterWebkit extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategoryWebkit.class;
	private static final String packageName = "org.qtjambi.qt.webkit";
	private static final String className = "QWebView";
	...
	public FilterWebkit(boolean includeFlag) {
		super(includeFlag);
	}
