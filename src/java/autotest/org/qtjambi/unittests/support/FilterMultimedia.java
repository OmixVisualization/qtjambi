...
public class FilterMultimedia extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategoryMultimedia.class;
	private static final String packageName = "org.qtjambi.qt.multimedia";
	private static final String className = "QAudio";
	...
	public FilterMultimedia() {
		super();
	}
	public FilterMultimedia(boolean includeFlag) {
		super(includeFlag);
	}
