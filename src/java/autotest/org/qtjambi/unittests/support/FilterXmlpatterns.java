...
public class FilterXmlpatterns extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategoryXmlpatterns.class;
	private static final String packageName = "org.qtjambi.qt.xmlpatterns";
	private static final String className = "QXmlQuery";
	...
	public FilterXmlpatterns() {
		super();
	}
	public FilterXmlpatterns(boolean includeFlag) {
		super(includeFlag);
	}
