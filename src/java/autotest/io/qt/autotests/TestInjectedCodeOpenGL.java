...
import io.qt.unittests.support.CategoryOpenGL;
...
public class TestInjectedCodeOpenGL extends QApplicationTest {
    ...
    public void testQGLColorMapSetEntries() {
        int firstColors[] = { new QColor(io.qt.core.Qt.GlobalColor.red).rgba(), new QColor(io.qt.core.Qt.GlobalColor.green).rgba() };
        int secondColors[] = { new QColor(io.qt.core.Qt.GlobalColor.blue).rgba(), new QColor(io.qt.core.Qt.GlobalColor.yellow).rgba() };

        QGLColormap map = new QGLColormap();
        map.setEntries(firstColors);
        assertEquals(new QColor(io.qt.core.Qt.GlobalColor.red).rgba(), map.entryRgb(0));
        assertEquals(new QColor(io.qt.core.Qt.GlobalColor.green).rgba(), map.entryRgb(1));

        map.setEntries(secondColors, 1);
        assertEquals(new QColor(io.qt.core.Qt.GlobalColor.red).rgba(), map.entryRgb(0));
        assertEquals(new QColor(io.qt.core.Qt.GlobalColor.blue).rgba(), map.entryRgb(1));
    }
