...
public class TestInjectedCodeLocation extends QApplicationTest {
    ...
    public void test()
    {
		...
		if(pluginLoader.isLoaded() || pluginLoader.load()){
			...
			Assert.assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(createRoutingManagerEngine.engine()));
		...
		if(pluginLoader.isLoaded() || pluginLoader.load()){
			...
			Assert.assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(createPlaceManagerEngine.engine()));
			Assert.assertEquals(QGeoServiceProvider.Error.NoError, createPlaceManagerEngine.error());
			Assert.assertEquals(null, createPlaceManagerEngine.errorString());
			...
			Assert.assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(createGeocodingManagerEngine.engine()));
			Assert.assertEquals(QGeoServiceProvider.Error.NoError, createGeocodingManagerEngine.error());
			Assert.assertEquals(null, createGeocodingManagerEngine.errorString());
