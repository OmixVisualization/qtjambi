...
public class TestCharts extends QApplicationTest {
    ...
    public void testBarSeries() {
    	...
    	series.append(set);
    	assertEquals(QtJambiInternal.Ownership.Cpp, QtJambiInternal.ownership(set));
    ...
    public void testAreaSeries() {
    	...
    	assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(lower));
    	assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(upper));
