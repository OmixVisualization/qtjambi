...
public class TestFutureQt6 extends QApplicationTest {
	
	static class FutureWatcher extends QFutureWatcherBase{
    ...
    public static void main(String args[]) {
        org.junit.runner.JUnitCore.main(TestFutureQt6.class.getName());
    }
}
