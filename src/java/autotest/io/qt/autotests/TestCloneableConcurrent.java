...
public class TestCloneableConcurrent extends QApplicationTest {
	...
	@Test
	public void run_clone_QVoidFuture() {
		QVoidFuture org = QtConcurrent.run(()->{});
		QVoidFuture clone = org.clone();
		assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(clone));
		org.dispose();
		QVoidFuture clone2 = clone.clone();
		assertEquals(QtJambiInternal.Ownership.Java, QtJambiInternal.ownership(clone2));
		assertEquals(clone, clone2);
	}
