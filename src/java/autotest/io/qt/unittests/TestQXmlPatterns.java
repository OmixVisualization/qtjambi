...
public class TestQXmlPatterns extends QApplicationTest {

    QXmlQuery query;
    QXmlSerializer serializer;
    QXmlResultItems xmlResultItems;
    QXmlFormatter formatter;
    String samplePath1 = "doc('file:/:classpath:/io/qt/unittests/xquerySample1.xml')";
    String samplePath2 = "doc('file:/:classpath:/io/qt/unittests/xmlSample2.xml')";
