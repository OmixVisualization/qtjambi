...
public class TestMemoryManagementSharedQObjectType extends MemoryManagement {
    @Override
    ...
    protected QtObject createInstanceInJava() {
        QtObject o = QObjectType.asSharedPointer(new QObjectType());
    ...
    protected QtObject createInstanceInNative() {
        QtObject o = QObjectType.newSharedInstance();
        accountingForObject(o);
        return o;
    }
    ...
    public static void main(String args[]) {
        org.junit.runner.JUnitCore.main(TestMemoryManagementSharedQObjectType.class.getName());
    }
}
