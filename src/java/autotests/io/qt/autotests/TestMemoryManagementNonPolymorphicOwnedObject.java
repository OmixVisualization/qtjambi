...
public class TestMemoryManagementNonPolymorphicOwnedObject extends MemoryManagement {
    ...
    protected String className() {
        return "NonPolymorphicOwnedObjectType";
    }
    ...
    public static void main(String args[]) {
        org.junit.runner.JUnitCore.main(TestMemoryManagementNonPolymorphicOwnedObject.class.getName());
    }
}
