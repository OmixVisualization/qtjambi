...
public class TestReferenceCountingQMultiMapNested extends ApplicationInitializer {
	
	public static final int COUNT = 10;
    
    @Test
    public void test_owner_QMultiMap_value_QSet_QList_TextCursor() throws InterruptedException {
