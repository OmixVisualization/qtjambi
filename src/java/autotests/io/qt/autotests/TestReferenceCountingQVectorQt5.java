...
public class TestReferenceCountingQVectorQt5 extends ApplicationInitializer {
	
	public static final int COUNT = 10;
	
	@Test
    public void test_new_QVector_QObject() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
	    	QVector<QObject> container = new QVector<>(QObject.class);
	        ...
	        for (int i = 0; i < 20 && counter.get()==0; i++) {
	            ...
	            synchronized(TestReferenceCountingQVectorQt5.class) {
	            	Thread.sleep(25);
	            }
    ...
    @Test
    public void test_new_QVector_QRunnable() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
	    	QVector<QRunnable> container = new QVector<>(QRunnable.class);
	    	for(int i=0; i<COUNT; ++i) {
    ...
    @Test
    public void test_new_QVector_QGraphicsItem() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
	    	QVector<QGraphicsItem> container = new QVector<>(QGraphicsItem.class);
	    	for(int i=0; i<COUNT; ++i) {
    ...
    @Test
    public void test_cpp_QVector_QObject() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
	    	QVector<QObject> container = Tulip.createVectorOfObjects();
	    	for(int i=0; i<100; ++i) {
	    		QObject object = new QObject();
	    		QtUtilities.getSignalOnDispose(object).connect(counter::incrementAndGet);
	    		container.add(object);
    ...
    @Test
    public void test_cpp_QVector_QRunnable() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
	    	QVector<QRunnable> container = Tulip.createVectorOfRunnables();
	    	for(int i=0; i<100; ++i) {
	    		QRunnable object = new QRunnable() { @Override public void run() {} };
	    		container.add(object);
	    		QtUtilities.getSignalOnDispose(object).connect(counter::incrementAndGet);
    ...
    @Test
    public void test_cpp_QVector_QEasingCurve_EasingFunction() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	TreeMap<Integer,Double> calls = new TreeMap<>();
    	{
	    	QVector<QEasingCurve.EasingFunction> container = Tulip.createVectorOfEasingFunctions();
    ...
    @Test
    public void test_java_QVector_QEasingCurve_EasingFunction() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	TreeMap<Integer,Double> calls = new TreeMap<>();
    	{
	    	QVector<QEasingCurve.EasingFunction> container = new QVector<>(QEasingCurve.EasingFunction.class);
	    	Assert.assertTrue(container!=null);
	    	for(int i=0; i<100; ++i) {
	    		int _i = i;
	    		QEasingCurve.EasingFunction object = progress -> {
    ...
    @Test
    public void test_cpp_QVector_Tulip_TestStdFunction() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	TreeMap<Integer,Integer> calls = new TreeMap<>();
    	{
	    	QVector<Tulip.TestStdFunction> container = Tulip.createVectorOfStdFunctions();
	    	Assert.assertTrue(container!=null);
	    	for(int i=0; i<100; ++i) {
	    		int _i = i;
    ...
    @Test
    public void test_java_QVector_Tulip_TestStdFunction() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	TreeMap<Integer,Integer> calls = new TreeMap<>();
    	{
	    	QVector<Tulip.TestStdFunction> container = new QVector<>(Tulip.TestStdFunction.class);
	    	Assert.assertTrue(container!=null);
	    	for(int i=0; i<100; ++i) {
	    		int _i = i;
	    		Tulip.TestStdFunction object = (int arg__1, boolean arg__2, double arg__3) -> {
    ...
    @Test
    public void test_QVector_assign() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
	    	QVector<QWidgetItem> container = new QVector<>(QWidgetItem.class);
	    	for (int i = 0; i < COUNT; i++) {
	        ...
	        Assert.assertEquals(0, counter.get());
	    	{
	    		QWidgetItem item = new QWidgetItem(null);
	    		QtUtilities.getSignalOnDispose(item).connect(counter::incrementAndGet);
	    		container.assign(QVector.of(item));
	    	}
	        ...
	        container.swap(new QVector<>(QWidgetItem.class));
	    	for (int i = 0; i < 50 && counter.get()<COUNT+1; i++) {
	            ApplicationInitializer.runGC();
	            synchronized(TestReferenceCountingQVectorQt5.class) {
	            	Thread.sleep(25+i*10);
    ...
    @Test
    public void test_owner_QVector_TextCursor() throws InterruptedException {
    	QTextDocument owner = new QTextDocument();
		QVector<QTextCursor> list = QVector.of(new QTextCursor(owner));
    ...
    @Test
    public void testQVector_mid() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	QVector<QWidgetItem> list = new QVector<>(QWidgetItem.class);
    	for (int i = 0; i < COUNT; i++) {
    		QWidgetItem item = new QWidgetItem(null);
    		QtUtilities.getSignalOnDispose(item).connect(counter::incrementAndGet);
    		list.add(item);
		}
		QVector<QWidgetItem> mid = list.mid(2, 1);
    ...
    @Test
    public void test_QVector_QObject_as_QVariant() throws InterruptedException {
    	AtomicInteger counter = new AtomicInteger();
    	{
