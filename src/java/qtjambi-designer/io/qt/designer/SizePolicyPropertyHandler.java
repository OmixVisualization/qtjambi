...
class SizePolicyPropertyHandler extends AbstractPropertyHandler {
    public Object create(QDomElement e) throws QUiLoaderException {
        ...
        QSizePolicy.Policy hPolicy = hSizeType.length() == 0
                ? io.qt.internal.QtJambiInternal.resolveEnum(QSizePolicy.Policy.class, childIntValue(e, "hsizetype"))
                : QSizePolicy.Policy.valueOf(hSizeType);

        QSizePolicy.Policy vPolicy = vSizeType.length() == 0
                ? io.qt.internal.QtJambiInternal.resolveEnum(QSizePolicy.Policy.class, childIntValue(e, "vsizetype"))
