        ...
        public void setProperty(String name, Object value) {
            if (name.equals("toolBarArea")) {
                ...
                if (mw != null && parent instanceof QToolBar)
                    mw.addToolBar(io.qt.internal.QtJambiInternal.resolveEnum(Qt.ToolBarArea.class, (Integer) value), (QToolBar) parent);
            } else if (name.equals("dockWidgetArea")) {
                QMainWindow mw = mainWindow();
                if (mw != null && parent instanceof QDockWidget)
                    mw.addDockWidget(io.qt.internal.QtJambiInternal.resolveEnum(Qt.DockWidgetArea.class, (Integer) value), (QDockWidget) parent);
            }
...
//       --parseDepth;
    ...
    private void parseLayout(QDomNode node) throws QUiLoaderException {
        ...
        QLayout layout = null;
        try {
            layout = (QLayout) cls.getConstructor().newInstance();
        } catch (Exception e) {
    ...
    private Class<? extends QObject> loadClass(String cls) throws QUiLoaderException {
        ...
        try {
            ...
            try {
                cl = Class.forName("io.qt.gui." + cls).asSubclass(QObject.class);
            } catch (Exception ex) {
    ...
    private void setProperty(QObject o, String property, Object value) {
        try {
            ...
            java.util.logging.Logger.getLogger("io.qt.designer").log(java.util.logging.Level.SEVERE, "setProperty failed: value=" + value + ", name=" + property + ", on=" + o, e);
        }
    ...
    private void parseConnections(QDomNode node) throws QUiLoaderException {
        ...
        for (QDomElement el = e.firstChildElement(); !el.isNull(); el = el.nextSiblingElement()) {
            if (el.nodeName().equals("connection")) {
                ...
                try {
                	QMetaObject.AbstractSignal signal = (QMetaObject.AbstractSignal) sender.getClass().getField(signalName).get(sender);
            ...
            java.util.logging.Logger.getLogger("io.qt.designer").log(java.util.logging.Level.SEVERE, "", ex);
        }
    }
    ...
    private QAction existingAction(String name) {
        ...
        if (action == null) {
            action = new QAction((QObject)null);
