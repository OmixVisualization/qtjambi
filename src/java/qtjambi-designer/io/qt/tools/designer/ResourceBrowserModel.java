...
import io.qt.QNativePointer.Type;
...
public class ResourceBrowserModel extends QAbstractItemModel {
    ...
    static {
        String extra = System.getProperty("io.qt.qtjambi.internal.extra_classpath");
        if (extra != null) {
        	io.qt.core.QAbstractFileEngine.addSearchPathForResourceEngine(extra);
        }
