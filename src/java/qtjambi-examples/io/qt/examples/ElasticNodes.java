...
public class ElasticNodes extends QGraphicsView {
    ...
    private static final QBrush BRUSH_DARK_GRAY = new QBrush(new QColor(io.qt.core.Qt.GlobalColor.darkGray));
    private static final QPen QPEN_EDGE = new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 1, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap, Qt.PenJoinStyle.RoundJoin);
    private static final QPen QPEN_BLACK = new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 0);
    ...
    static{
        ...
        GRADIENT_SUNKEN.setColorAt(1, new QColor(new QColor(io.qt.core.Qt.GlobalColor.yellow)).lighter(120));
        GRADIENT_SUNKEN.setColorAt(0, new QColor(new QColor(io.qt.core.Qt.GlobalColor.darkYellow)).lighter(120));

        GRADIENT_NORMAL = new QRadialGradient(-3, -3, 10);
        GRADIENT_NORMAL.setColorAt(0, new QColor(io.qt.core.Qt.GlobalColor.yellow));
        GRADIENT_NORMAL.setColorAt(1, new QColor(io.qt.core.Qt.GlobalColor.darkYellow));
    }
    ...
    protected void drawBackground(QPainter painter, QRectF rect) {
        ...
        gradient.setColorAt(0, new QColor(io.qt.core.Qt.GlobalColor.white));
        gradient.setColorAt(1, new QColor(io.qt.core.Qt.GlobalColor.lightGray));
        ...
        painter.setPen(new QColor(io.qt.core.Qt.GlobalColor.lightGray));
        painter.drawText(textRect.translated(2, 2), message);
        painter.setPen(new QColor(io.qt.core.Qt.GlobalColor.black));
    ...
    public class Node extends QGraphicsItem {
        ...
        public void paint(QPainter painter, QStyleOptionGraphicsItem option, QWidget widget) {
            ...
            painter.setBrush(QColor.fromRgba(new QColor(io.qt.core.Qt.GlobalColor.black).rgb() & 0x7fffffff));
    ...
    public class Edge extends QGraphicsItem {
        ...
        public void paint(QPainter painter, QStyleOptionGraphicsItem option, QWidget widget) {
            ...
            painter.setBrush(new QColor(io.qt.core.Qt.GlobalColor.black));
