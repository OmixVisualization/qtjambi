...
//! [10]
            brush = new QBrush(new QColor(io.qt.core.Qt.GlobalColor.darkBlue),Qt.BrushStyle.SolidPattern);
...
//! [12]
            brush = new QBrush(new QColor(io.qt.core.Qt.GlobalColor.darkMagenta));
...
//! [13]
            brush = new QBrush(new QColor(io.qt.core.Qt.GlobalColor.gray), Qt.BrushStyle.SolidPattern);
            pattern = new QRegExp("//[^\n]*");
...
//! [13]
            ...
            // String
//! [14]
            brush = new QBrush(new QColor(io.qt.core.Qt.GlobalColor.blue), Qt.BrushStyle.SolidPattern);
            pattern = new QRegExp("\".*\"");
...
//! [14]
            ...
            // Function
            brush = new QBrush(new QColor(io.qt.core.Qt.GlobalColor.darkGreen), Qt.BrushStyle.SolidPattern);
