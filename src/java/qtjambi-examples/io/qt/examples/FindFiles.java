...
//! [0]
    public FindFiles()
    {
        browseButton = createButton(tr("&Browse..."), this::browse);
        findButton = createButton(tr("&Find"), this::find);
...
//! [9]
    private QPushButton createButton(String text, Slot0 goldMember)
    {
        QPushButton button = new QPushButton(text);
        button.clicked.connect(goldMember);
