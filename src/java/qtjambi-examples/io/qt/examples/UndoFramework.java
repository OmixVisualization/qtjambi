...
import io.qt.widgets.QUndoView;
...
//! [1]
    public UndoFramework()
    {
        ...
        undoStack.canRedoChanged.connect(redoAction::setEnabled);
        undoStack.canUndoChanged.connect(undoAction::setEnabled);
        ...
        diagramScene.itemMoved.connect(this::itemMoved);
