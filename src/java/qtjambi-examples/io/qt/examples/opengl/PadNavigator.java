...
package io.qt.examples.opengl;

import io.qt.examples.QtJambiExample;
import io.qt.QSignalEmitter.Signal0;
...
import io.qt.opengl.QGL;
import io.qt.opengl.QGLFormat;
import io.qt.opengl.QGLWidget;
...
import io.qt.widgets.QGraphicsView.CacheModeFlag;
import io.qt.widgets.QGraphicsView.ViewportUpdateMode;
...
public class PadNavigator extends QGraphicsView {
    ...
    private static class RoundRectItem extends QGraphicsRectItem {
        ...
        public void paint(QPainter painter, QStyleOptionGraphicsItem option, QWidget widget) {
            ...
            painter.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 1));
    ...
    public PadNavigator(int width, int height) {
        ...
        selectionItem = new RoundRectItem(new QRectF(-60, -60, 120, 120), new QColor(io.qt.core.Qt.GlobalColor.gray), null);
