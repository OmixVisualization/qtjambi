...
//! [12]
        localeCombo.currentIndexChanged.connect(this::localeChanged);
        firstDayCombo.currentIndexChanged.connect(this::firstDayChanged);
        selectionModeCombo.currentIndexChanged.connect(this::selectionModeChanged);
        gridCheckBox.toggled.connect(calendar::setGridVisible);
        navigationCheckBox.toggled.connect(calendar::setNavigationBarVisible);
        horizontalHeaderCombo.currentIndexChanged.connect(this::horizontalHeaderChanged);
        verticalHeaderCombo.currentIndexChanged.connect(this::verticalHeaderChanged);
//! [12]
...
//! [14] //! [15]
        currentDateEdit.dateChanged.connect(calendar::setSelectedDate);
        calendar.selectionChanged.connect(this::selectedDateChanged);
        minimumDateEdit.dateChanged.connect(this::minimumDateChanged);
        maximumDateEdit.dateChanged.connect(this::maximumDateChanged);
