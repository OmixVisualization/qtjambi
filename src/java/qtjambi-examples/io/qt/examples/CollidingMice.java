...
//! [15]
        public void paint(QPainter painter,
            ...
            // Eyes
            brush.setColor(new QColor(io.qt.core.Qt.GlobalColor.white));
            painter.setBrush(brush);
            painter.drawEllipse(-10, -17, 8, 8);
            painter.drawEllipse(2, -17, 8, 8);

            // Nose
            brush.setColor(new QColor(io.qt.core.Qt.GlobalColor.black));
            painter.setBrush(brush);
            ...
            if (scene().collidingItems(this).isEmpty())
                brush.setColor(new QColor(io.qt.core.Qt.GlobalColor.darkYellow));
            else
                brush.setColor(new QColor(io.qt.core.Qt.GlobalColor.red));
            painter.setBrush(brush);
