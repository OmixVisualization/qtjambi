...
//! [4]
        ...
        newPalette.setColor(QPalette.ColorRole.Window, new QColor(io.qt.core.Qt.GlobalColor.white));
...
//! [11]
    public void dropEvent(QDropEvent event) {
        if (event.mimeData().hasFormat("application/x-fridgemagnet")) {
            io.qt.core.QMimeData mime = event.mimeData();
//! [11] //! [12]
...
//! [16]
            ...
            painter.setBrush(new QColor(io.qt.core.Qt.GlobalColor.white));
...
//! [19]
            io.qt.core.QMimeData mimeData = new io.qt.core.QMimeData();
