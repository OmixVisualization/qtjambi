...
public class CustomWidget extends QWidget {
    ...
    private QPen speedBarPen = new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 4);
    private QTimeLine timeLine = new QTimeLine(1, this); {
        timeLine.valueChanged.connect(this::animateSpeed);
    ...
    //
    private static final QColor NEEDLE_COLOR = new QColor(io.qt.core.Qt.GlobalColor.red);
    ...
    //
    private static final QColor BACKGROUND_COLOR = new QColor(io.qt.core.Qt.GlobalColor.white);
    ...
    //
    private static final QColor NEEDLE_FRAME_COLOR = new QColor(io.qt.core.Qt.GlobalColor.black);
    ...
    private void drawFrame(QPainter p) {
        ...
        p.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 2));
