...
//![cursorPositionChanged]
    private void highlightCurrentLine()
    {
        ...
        if (!isReadOnly()) {
            ...
            QColor lineColor = new QColor(io.qt.core.Qt.GlobalColor.yellow).lighter(160);

            QTextCharFormat format = selection.format();
            format.setBackground(new QBrush(lineColor));
            format.setProperty(QTextFormat.Property.FullWidthSelection.value(), Boolean.TRUE);
...
//![extraAreaPaintEvent_0]
    public void lineNumberAreaPaintEvent(QPaintEvent event)
    {
        ...
        painter.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.black)));
        painter.fillRect(event.rect(), new QBrush(new QColor(io.qt.core.Qt.GlobalColor.lightGray)));
