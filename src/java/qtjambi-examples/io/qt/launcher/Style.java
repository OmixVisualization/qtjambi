...
public class Style extends QCommonStyle {
    ...
    public static QPen PEN_BLACK = new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 0);
    ...
    static {
        ...
        GRADIENT_LIGHT.setColorAt(0.25, new QColor(io.qt.core.Qt.GlobalColor.white));
        ...
        GRADIENT_DARK.setColorAt(0, new QColor(io.qt.core.Qt.GlobalColor.white));
    ...
    public void drawScrollBarSlider(QStyleOptionSlider opt, QPainter p) {
        QRectF rect = new QRectF(opt.rect());
        p.save();
        p.fillRect(rect, new QBrush(new QColor(io.qt.core.Qt.GlobalColor.white)));
        QStyle.State state = opt.state();
