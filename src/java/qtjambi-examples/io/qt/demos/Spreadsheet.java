...
public class Spreadsheet extends QMainWindow {
    ...
    private void setupCellActions() {
        ...
        actionTextColor = new QAction(createPixmapForButton(tr("T"), new QColor(io.qt.core.Qt.GlobalColor.black), new QColor(io.qt.core.Qt.GlobalColor.transparent)), "&Color...", this);
        actionTextColor.triggered.connect(this, "textColor()");
        b.addAction(actionTextColor);
        m.addAction(actionTextColor);

        actionCellColor = new QAction(createPixmapForButton(tr("T"), new QColor(io.qt.core.Qt.GlobalColor.white), new QColor(io.qt.core.Qt.GlobalColor.black)), "&Color...", this);
    ...
    class CellDelegate extends QItemDelegate {
        ...
        public CellDelegate() {
            ...
            penBorder.setColor(new QColor(io.qt.core.Qt.GlobalColor.darkBlue));

            penNormal.setColor(new QColor(io.qt.core.Qt.GlobalColor.lightGray));
        }
    ...
    class TableView extends QTableView {
        ...
        protected void currentChanged(QModelIndex current, QModelIndex previous) {
            ...
            if (enabled) {
                ...
                actionTextColor.setIcon(createPixmapForButton(tr("T"), cell.textColor != null ? cell.textColor : new QColor(io.qt.core.Qt.GlobalColor.black), new QColor(io.qt.core.Qt.GlobalColor.transparent)));
                actionCellColor.setIcon(createPixmapForButton(tr("T"), new QColor(io.qt.core.Qt.GlobalColor.white), cell.backgroundColor != null ? cell.backgroundColor : new QColor(io.qt.core.Qt.GlobalColor.black)));
            } else {
                cellEdit.setText("");
            }
        }
