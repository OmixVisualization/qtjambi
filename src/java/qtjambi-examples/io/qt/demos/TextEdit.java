...
public class TextEdit extends QMainWindow {
    ...
    private void init() {
        ...
        textEdit.copyAvailable.connect(actionCut::setEnabled);
        textEdit.copyAvailable.connect(actionCopy::setEnabled);
    ...
    private void setupTextActions() {
        ...
        pix.fill(new QColor(io.qt.core.Qt.GlobalColor.black));
    ...
    public void textSize(String p) {
        textEdit.setFontPointSize(Float.valueOf(p));
    }
