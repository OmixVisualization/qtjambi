...
class ArthurFrame extends QWidget
{
    ...
    public ArthurFrame(QWidget parent)
    {
        ...
        m_tile.fill(new QColor(io.qt.core.Qt.GlobalColor.white));
    ...
    public void paintDescription(QPainter painter)
    {
        ...
        g.setColorAt(0, new QColor(io.qt.core.Qt.GlobalColor.black));
        g.setColorAt(0.9, new QColor(io.qt.core.Qt.GlobalColor.black));
        g.setColorAt(1, new QColor(io.qt.core.Qt.GlobalColor.transparent));
