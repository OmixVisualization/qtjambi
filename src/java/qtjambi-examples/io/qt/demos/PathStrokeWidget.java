...
import io.qt.gui.QPainterPathStroker;
...
public class PathStrokeWidget extends QWidget {
    ...
    public class PathStrokeRendrer extends ArthurFrame {
        ...
        public void paint(QPainter painter) {
            ...
            // Draw the path
            {
                QColor lg = new QColor(io.qt.core.Qt.GlobalColor.red);
                ...
                if (m_penStyle == Qt.PenStyle.NoPen) {
                    ...
                    Double space = Double.valueOf(4);
                    dashes.add(Double.valueOf(1.0));
                    dashes.add(space);
                    dashes.add(Double.valueOf(3.0));
                    dashes.add(space);
                    dashes.add(Double.valueOf(9.0));
                    dashes.add(space);
                    dashes.add(Double.valueOf(27.0));
                    dashes.add(space);
                    dashes.add(Double.valueOf(9.0));
                    dashes.add(space);
                    dashes.add(Double.valueOf(3.0));
            ...
            if (true) {
                ...
                painter.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.lightGray), 0, Qt.PenStyle.SolidLine));
