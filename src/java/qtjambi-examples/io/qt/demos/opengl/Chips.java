    ...
    class Chip extends QGraphicsItem {
        ...
        public void paint(QPainter painter, final QStyleOptionGraphicsItem option, QWidget widget) {
            ...
            if (option.levelOfDetail() < 0.2) {
                ...
                painter.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.black), 0));
            ...
            if (option.levelOfDetail() >= 1) {
                painter.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.gray), 1));
            ...
            // Draw red ink
            if (stuff.size() > 1) {
                painter.setPen(new QPen(new QColor(io.qt.core.Qt.GlobalColor.red), 1, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap, Qt.PenJoinStyle.RoundJoin));
