...
public abstract class Constants {
    ...
    public static final String DECLARATIVE_WEBKIT = "qtjambi.declarative.webkit";
    ...
    public static final String QML_QTCANVAS3D_QTCANVAS3D = "qtjambi.QtCanvas3D.qtcanvas3d";
