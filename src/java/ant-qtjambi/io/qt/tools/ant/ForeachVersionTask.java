...
public class ForeachVersionTask extends Task {
	...
	public void execute() throws BuildException {
		...
		for (String key : Arrays.asList("java.srcdir", "qtjambi.build.module", "qtjambi.autotests",
				"qtjambi.autotests.enable.criticals", "qtjambi.autotests.jnicheck")) {
		...
		if(dirs!=null && !dirs.isEmpty()) {
			...
			if(base==null) {
				...
				if (QTDIR == null || QTDIR.isEmpty() || !new java.io.File(QTDIR).exists()) {
