...
public class VersionPropertiesTask extends Task {
    ...
    public void execute() throws BuildException {
        ...
        File fileVersion = new File(new File(targetdir==null ? AntUtil.getPropertyAsString(propertyHelper, "java.outdir") : targetdir), tmpPathVersionProperties);
    ...
    private boolean buildNewVersionProperties(File fileVersion, File fileTemplate, String qtVersion, String libInfix, String qtjambiSonameVersionMajor) {
        ...
        if(true /*&& !foundInVersionPropertiesTemplate*/) {
            ...
            if(fileTemplate.exists()) {
                ...
                try(OutputStream outStream = new FileOutputStream(fileOut)){
                ...
                allOk = true;
	            getProject().log(this, "File rebuilt " + fileOut.getAbsolutePath() + " from template file " + fileTemplate.getAbsolutePath(), Project.MSG_INFO);
            }
        }
