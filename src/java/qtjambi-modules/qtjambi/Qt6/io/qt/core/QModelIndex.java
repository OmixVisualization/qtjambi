	...
	java.lang.Cloneable
{
    	...
    	return  row <  other.row
                || (row == other.row && (column <  other.column
                                 || (column == other.column && (internalId <  other.internalId
                                                  || (internalId == other.internalId && QtJambi_LibraryUtilities.internal.nativeId(model) < QtJambi_LibraryUtilities.internal.nativeId(other.model))))));
    }
    ...
    @io.qt.QtUninvokable
    public final void multiData(java.util.Map<Integer,Object> roleDataSpan){
    	if(model!=null)
    		model.multiData(this, roleDataSpan);
    }
}
