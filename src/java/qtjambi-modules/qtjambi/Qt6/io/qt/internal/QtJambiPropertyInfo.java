...
public class QtJambiPropertyInfo {
	QtJambiPropertyInfo(Field reflectedField, QMetaType metaType) {
		super();
	...
	QtJambiPropertyInfo(Field reflectedField, QMetaProperty property) {
		super();
		this.reflectedField = reflectedField;
