...
public final class QVariant {
    ...
    public QVariant(int userType){
        this(userType, null);
    }
    
    public static QVariant fromValue(Object value){
        return new QVariant(type(value), value); 
    }
    
    public QVariant(int userType, Object value){
        this.userType = userType; 
        this.value = new QMetaType(userType).create(value);
    }
    ...
    @io.qt.NativeAccess
    public Object value() {
        return new QMetaType(userType).create(value);
    }
    ...
    public boolean isValid() {
        return userType!=QMetaType.Type.UnknownType.value();
    }
