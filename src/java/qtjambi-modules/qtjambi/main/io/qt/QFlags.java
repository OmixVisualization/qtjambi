...
import io.qt.internal.QtJambiEnums;
               ...
               Cloneable
{
     ...
     */
     ...
     /**
      * Tests if other flags are set.
      * @param flags other other flags
      * @return true if flag <code>other</code> is set
      */
     @SafeVarargs
	 public final boolean isSet(T ... flags) {
      ...
      */
      ...
      /**
       * Tests if given flags are set.
       * @param flags other flags
       * @return true if flags are set
       */
       @SafeVarargs
       public final boolean testFlags(T... flags) {
        ...
        * @return true if flags are set
        */
       public final boolean testFlags(QFlags<T> flags) {
        ...
        * @return true if flags are set
        */
       public final boolean testAnyFlags(QFlags<T> flags) {
    	   return (value & flags.value()) != 0;
       }

       /**
        * Tests if any of the given flags is set.
        * @param flags other flags
        * @return true if any of the given flags is set
        */
        @SafeVarargs
        public final boolean testAnyFlags(T... flags) {
     	   QFlags<T> f = this.clone();
     	   f.clearAll();
     	   f.set(flags);
      ...
      */
	 public T[] flags() {
		 return flags(QtJambiEnums.flagConstants(this));
     }
