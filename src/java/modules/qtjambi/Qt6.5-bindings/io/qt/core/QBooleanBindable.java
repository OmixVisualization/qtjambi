...
public final class QBooleanBindable extends QUntypedBindable {
	 ...
	 * @param property
	 */
	public QBooleanBindable(@StrictNonNull QObject object, @StrictNonNull String property) {
	 ...
	 * @param property
	 */
	public QBooleanBindable(@StrictNonNull QObject object, @StrictNonNull QMetaProperty property) {
		super(object, property, QBindable.bindableInterface(property));
		check();
		if(iface()==null)
			throw new IllegalArgumentException("Given QMetaProperty is not of boolean type.");
	}
