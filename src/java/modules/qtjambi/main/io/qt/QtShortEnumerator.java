 ...
 * Its sole purpose is to unify the access to the <code>short</code>
...
public interface QtShortEnumerator extends QtAbstractEnumerator {
    /**
     * This function should return a short value for the enum
	 ...
	 * @return comparator
	 */
	public static <E extends QtShortEnumerator> @NonNull Comparator<@StrictNonNull E> comparator() {
		return (@StrictNonNull E e1, @StrictNonNull E e2)->{
			return Short.compare(e1.value(), e2.value());
		};
	}
}
