...
public class QMap<K,V> extends io.qt.internal.AbstractMap<K,V> implements Cloneable
{
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeIterator<K,V> begin(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeIterator<K,V> end(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeConstIterator<K,V> constBegin(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeConstIterator<K,V> constEnd(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeConstIterator<K,V> find(long __this__nativeId, K key);
    ...
    @QtUninvokable
    static native <V> V first(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K> K firstKey(long __this__nativeId);
    ...
    @QtUninvokable
    static native <V> V last(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K> K lastKey(long __this__nativeId);
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeConstIterator<K,V> lowerBound(long __this__nativeId, K key);
    ...
    @QtUninvokable
    static native <K,V> io.qt.core.QAssociativeConstIterator<K,V> upperBound(long __this__nativeId, K key);
