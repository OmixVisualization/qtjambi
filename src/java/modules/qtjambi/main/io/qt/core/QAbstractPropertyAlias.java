...
abstract class QAbstractPropertyAlias extends QPropertyObserver {
	...
	QAbstractPropertyAlias(io.qt.core.QUntypedPropertyData aliasedPropertyPtr, QBindableInterface iface) {
		...
		initialize_native(this, Objects.requireNonNull(aliasedPropertyPtr));
		this.iface = iface;
	...
	QAbstractPropertyAlias(QAbstractPropertyAlias other) {
		super((QPrivateConstructor)null);
		initialize_native(this, Objects.requireNonNull(other.aliasedProperty()));
	...
	private native static void initialize_native(Object instance, io.qt.core.QUntypedPropertyData aliasedPropertyPtr);
