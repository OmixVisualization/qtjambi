...
public final class QGenericArgument extends QGenericArgumentType<Object>{
	...
	public static QGenericArgument of(Object value){
		return new QGenericArgument(value==null ? null : QtJambi_LibraryUtilities.internal.getClass(value), value==null || value instanceof Object[] ? null : metaType(value), 0, value);
	}
	
	private static QMetaType metaType(Object obj) {
        if(obj==null)
            return new QMetaType(QMetaType.Type.Nullptr);
        if(obj instanceof QGenericArgumentType<?>)
            return ((QGenericArgumentType<?>)obj).metaType;
        ...
        return QMetaType.fromType(QtJambi_LibraryUtilities.internal.getClass(obj));
    }
