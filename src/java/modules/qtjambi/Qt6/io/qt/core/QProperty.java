...
public final class QProperty<T> extends QPropertyData<T> {
	...
	native static <T> void initialize_native(QPropertyData<T> instance, QMetaType metaType, Object val);
	...
	@QtUninvokable
	static native <T> T getValueBypassingBindings(long data, long metaType);
