...
typedef qintptr(*Call)(QFunctionPointer fn, qintptr p1, qintptr p2, qintptr p3, qintptr p4, qintptr p5, qintptr p6);
...
struct FunctionInitializer{
    ...
    static qintptr f(qintptr p1, qintptr p2, qintptr p3, qintptr p4, qintptr p5, qintptr p6) {
        if(!call[N])reinterpret_cast<QFunctionPointer>(call[0])();
        return call[N](reinterpret_cast<QFunctionPointer>(&f), p1, p2, p3, p4, p5, p6);
    }
};
