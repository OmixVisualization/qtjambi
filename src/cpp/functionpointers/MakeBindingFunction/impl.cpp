...
typedef QUntypedPropertyBinding(*Call)(QFunctionPointer fn,const QUntypedPropertyData *,const QPropertyBindingSourceLocation&);
...
struct FunctionInitializer{
    ...
    static QUntypedPropertyBinding f(const QUntypedPropertyData * d, const QPropertyBindingSourceLocation& l) {
        if(!call[N])reinterpret_cast<QFunctionPointer>(call[0])();
        return call[N](reinterpret_cast<QFunctionPointer>(&f), d, l);
    }
};
