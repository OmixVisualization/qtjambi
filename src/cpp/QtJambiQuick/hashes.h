...
inline size_t qHash(const QSGMaterialShader::RenderState &value, size_t seed = 0)
{
...
inline size_t qHash(const QSGMaterialShader::GraphicsPipelineState &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QSGGeometry::ColoredPoint2D &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QSGGeometry::TexturedPoint2D &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QSGGeometry::Point2D &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QSGGeometry::Attribute &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QSGGeometry::AttributeSet &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
#include <QtQuick/QQuickWindow>
inline size_t qHash(const QQuickWindow::GraphicsStateInfo &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QQuickGraphicsDevice &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QQuickGraphicsConfiguration &value, size_t seed = 0)
{
#if QT_VERSION < QT_VERSION_CHECK(6, 10, 0)
    QtPrivate::QHashCombine hash;
#else
...
inline size_t qHash(const QQuickRenderTarget &value, size_t seed = 0)
{
...
#else
size_t qHash(const QQuickRenderTarget &value, size_t seed = 0);
#endif
