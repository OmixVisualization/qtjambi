...
#ifndef QTJAMBISHELL_QQMLLISTPROPERTY_H
#define QTJAMBISHELL_QQMLLISTPROPERTY_H
...
class QtJambiLink;
class QtJambiShell_QQmlListProperty : public QtjambiQmlListProperty
{
public:
    QtJambiShell_QQmlListProperty();
    QtJambiShell_QQmlListProperty(QObject*  o0, QList<QObject*>&  list1);
    ~QtJambiShell_QQmlListProperty();
...
#endif // QTJAMBISHELL_QQMLLISTPROPERTY_H
