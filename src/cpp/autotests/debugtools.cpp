...
extern "C" Q_DECL_EXPORT void JNICALL Java_io_qt_autotests_DebugTools_enableCounters(JNIEnv *, jclass)
{
    QWriteLocker locker(gCountsForNameLock());
    *gEnabled = true;
...
extern "C" Q_DECL_EXPORT void JNICALL Java_io_qt_autotests_DebugTools_disableCounters(JNIEnv *, jclass)
{
    QWriteLocker locker(gCountsForNameLock());
    *gEnabled = false;
...
Java_io_qt_autotests_DebugTools_reset_1##NAME(JNIEnv *env, jclass, jstring className)\
{ \
    reset(TestAPI::DebugCounters::NAME, qtjambi_to_qbytearray(env, className)); \
} \
\
extern "C" Q_DECL_EXPORT jint JNICALL Java_io_qt_autotests_DebugTools_##NAME(JNIEnv *env, jclass, jstring className) \
{ \
