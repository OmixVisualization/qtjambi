...
class GenericMapAccess : public AbstractMapAccess, public AbstractNestedAssociativeAccess {
...
public:
    ...
    int registerContainer(const QByteArray& containerTypeName) override {
        return QtJambiPrivate::registerAssociativeContainerType<QMap<K,T>, size1, size2>(containerTypeName, m_keyMetaTypeInfo.metaType(), m_valueMetaTypeInfo.metaType(), this);
    }
...
public:
    ...
    jobject begin(JNIEnv * env, const ExtendedContainerInfo& container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      container.nativeId,
                                      new Iterator{reinterpret_cast<QMap<K,T> *>(container.container)->begin()},
    ...
    jobject end(JNIEnv * env, const ExtendedContainerInfo& container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      container.nativeId,
                                      new Iterator{reinterpret_cast<QMap<K,T> *>(container.container)->end()},
                                      [](void* ptr,bool){ delete reinterpret_cast<Iterator*>(ptr); },
                                      access);
        return result;
    }
    ...
    jobject constBegin(JNIEnv * env, const ConstExtendedContainerInfo& container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      container.nativeId,
                                      new typename QMap<K,T>::const_iterator(reinterpret_cast<const QMap<K,T> *>(container.container)->constBegin()),
    ...
    jobject constEnd(JNIEnv * env, const ConstExtendedContainerInfo& container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      container.nativeId,
                                      new typename QMap<K,T>::const_iterator(reinterpret_cast<const QMap<K,T> *>(container.container)->constEnd()),
                                      [](void* ptr,bool){ delete reinterpret_cast<typename QMap<K,T>::const_iterator*>(ptr); },
                                      access);
        return result;
    }
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                ...
                result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                              container.nativeId,
                                              new Iterator{reinterpret_cast<QMap<K,T> *>(container.container)->find(_qkey)},
                                              [](void* ptr,bool){ delete reinterpret_cast<Iterator*>(ptr); },
                                              access);
            }
        }
    ...
    jobject constFind(JNIEnv * env, const ConstExtendedContainerInfo& container, jobject key) override {
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                ...
                result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                              container.nativeId,
                                              new typename QMap<K,T>::const_iterator(reinterpret_cast<const QMap<K,T> *>(container.container)->constFind(_qkey)),
                                              [](void* ptr,bool){ delete reinterpret_cast<typename QMap<K,T>::const_iterator*>(ptr); },
                                              access);
            }
        }
    ...
    void clear(JNIEnv *, const ContainerInfo& container) override {
        QTJAMBI_KEY_VALUE_LOCKER(this);
        reinterpret_cast<QMap<K,T> *>(container.container)->clear();
    }
        ...
        QTJAMBI_KEY_VALUE_LOCKER(this);
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, jv, _qkeyPtr, jValueType::l)){
                ...
                if(m_valueExternalToInternalConverter(env, nullptr, jv, _qvaluePtr, jValueType::l)){
                    reinterpret_cast<QMap<K,T> *>(container.container)->insert(_qkey, _qvalue);
                }
    ...
    ContainerAndAccessInfo keys(JNIEnv * env, const ConstContainerInfo& container) override {
        ...
        if(result.access){
            result.container = new QList<K>(reinterpret_cast<const QMap<K,T> *>(container.container)->keys());
    ...
    ContainerAndAccessInfo keys(JNIEnv * env, const ConstContainerInfo& container, jobject value) override {
        ...
        if(result.access){
            ...
            void *_qvaluePtr = &_qvalue;
            if(m_valueExternalToInternalConverter(env, nullptr, jv, _qvaluePtr, jValueType::l)){
                result.container = new QList<K>(reinterpret_cast<const QMap<K,T> *>(container.container)->keys(_qvalue));
                result.object = ContainerAPI::objectFromQList(env, result.container, result.access);
            }
        }
        return result;
    ...
    jobject constLowerBound(JNIEnv * env, const ConstExtendedContainerInfo& container, jobject key) override {
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                ...
                result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                              container.nativeId,
                                              new typename QMap<K,T>::const_iterator(reinterpret_cast<const QMap<K,T> *>(container.container)->lowerBound(_qkey)),
                                              [](void* ptr,bool){ delete reinterpret_cast<typename QMap<K,T>::const_iterator*>(ptr); },
                                              access);
            }
        }
    ...
    jint remove(JNIEnv * env, const ContainerInfo& container,jobject key) override {
        ...
        jint result = 0;
        {
            ...
            void *_qkeyPtr = &_qkey;
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                result = reinterpret_cast<QMap<K,T> *>(container.container)->remove(_qkey);
            }
        }
        return result;
    }
    ...
    jobject take(JNIEnv *env, const ContainerInfo& container, jobject key) override {
        ...
        void *_qkeyPtr = &_qkey;
        if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
            T _qvalue = reinterpret_cast<QMap<K,T> *>(container.container)->take(_qkey);
            jvalue _value;
            _value.l = nullptr;
    ...
    jobject constUpperBound(JNIEnv * env, const ConstExtendedContainerInfo& container, jobject key) override {
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                ...
                result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                              container.nativeId,
                                              new typename QMap<K,T>::const_iterator(reinterpret_cast<const QMap<K,T> *>(container.container)->upperBound(_qkey)),
                                              [](void* ptr,bool){ delete reinterpret_cast<typename QMap<K,T>::const_iterator*>(ptr); },
                                              access);
            }
        }
    ...
    ContainerAndAccessInfo values(JNIEnv * env, const ConstContainerInfo& container) override {
        ...
        if(result.access){
            result.container = new QList<T>(reinterpret_cast<const QMap<K,T> *>(container.container)->values());
            result.object = ContainerAPI::objectFromQList(env, result.container, result.access);
        }
        return result;
    }
