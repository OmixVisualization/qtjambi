...
public:
    ...
    int registerContainer(const QByteArray& containerTypeName) override {
        return QtJambiPrivate::registerAssociativeContainerType<QMultiMap<K,T>, size1, size2>(containerTypeName, m_keyMetaTypeInfo.metaType(), m_valueMetaTypeInfo.metaType());
    }
...
public:
    ...
    jobject begin(JNIEnv * env, QtJambiNativeID ownerId, void* container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      ownerId,
                                      new Iterator{reinterpret_cast<QMultiMap<K,T> *>(container)->begin()},
    ...
    jobject end(JNIEnv * env, QtJambiNativeID ownerId, void* container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      ownerId,
                                      new Iterator{reinterpret_cast<QMultiMap<K,T> *>(container)->end()},
                                      [](void* ptr,bool){ delete reinterpret_cast<Iterator*>(ptr); },
                                      access);
        return result;
    }
    ...
    jobject constBegin(JNIEnv * env, QtJambiNativeID ownerId, const void* container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      ownerId,
                                      new typename QMultiMap<K,T>::const_iterator(reinterpret_cast<const QMultiMap<K,T> *>(container)->constBegin()),
                                      [](void* ptr,bool){ delete reinterpret_cast<typename QMultiMap<K,T>::const_iterator*>(ptr); },
                                      access);
        return result;
    }
    ...
    jobject constEnd(JNIEnv * env, QtJambiNativeID ownerId, const void* container) override {
        ...
        jobject result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                      ownerId,
                                      new typename QMultiMap<K,T>::const_iterator(reinterpret_cast<const QMultiMap<K,T> *>(container)->constEnd()),
                                      [](void* ptr,bool){ delete reinterpret_cast<typename QMultiMap<K,T>::const_iterator*>(ptr); },
                                      access);
        return result;
    }
    ...
    jobject find(JNIEnv * env, QtJambiNativeID ownerId, void* container, jobject key) override {
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                ...
                result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                              ownerId,
                                              new Iterator{reinterpret_cast<QMultiMap<K,T> *>(container)->find(_qkey)},
                                              [](void* ptr,bool){ delete reinterpret_cast<Iterator*>(ptr); },
                                              access);
            }
        }
    ...
    jobject constFind(JNIEnv * env, QtJambiNativeID ownerId, const void* container, jobject key) override {
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, _key, _qkeyPtr, jValueType::l)){
                ...
                result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                              ownerId,
                                              new typename QMultiMap<K,T>::const_iterator(reinterpret_cast<const QMultiMap<K,T> *>(container)->constFind(_qkey)),
                                              [](void* ptr,bool){ delete reinterpret_cast<typename QMultiMap<K,T>::const_iterator*>(ptr); },
                                              access);
            }
        }
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, jv, _qkeyPtr, jValueType::l)){
                ...
                if(m_valueExternalToInternalConverter(env, nullptr, jv, _qvaluePtr, jValueType::l)){
                    ...
                    result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                                  ownerId,
                                                  new Iterator{reinterpret_cast<QMultiMap<K,T> *>(container)->find(_qkey, _qvalue)},
                                                  [](void* ptr,bool){ delete reinterpret_cast<Iterator*>(ptr); },
                                                  access);
                }
            }
        ...
        jobject result = nullptr;
        {
            ...
            if(m_keyExternalToInternalConverter(env, nullptr, jv, _qkeyPtr, jValueType::l)){
                ...
                if(m_valueExternalToInternalConverter(env, nullptr, jv, _qvaluePtr, jValueType::l)){
                    ...
                    result = QtJambiAPI::convertQAssociativeIteratorToJavaObject(env,
                                                  ownerId,
                                                  new typename QMultiMap<K,T>::const_iterator(reinterpret_cast<const QMultiMap<K,T> *>(container)->constFind(_qkey, _qvalue)),
                                                  [](void* ptr,bool){ delete reinterpret_cast<typename QMultiMap<K,T>::const_iterator*>(ptr); },
                                                  access);
                }
            }
