 ...
 jobject t0)
{
    ...
    QTJAMBI_TRY{
        ...
        AbstractMapAccess* containerAccess = dynamic_cast<AbstractMapAccess*>(container.second);
        Q_ASSERT(containerAccess);
        result = containerAccess->lowerBound(__jni_env, __this_nativeId, container.first, t0);
    }QTJAMBI_CATCH(const JavaException& exn){
        exn.raiseInJava(__jni_env);
    }QTJAMBI_TRY_END
    return result;
 ...
 jobject t0)
{
    ...
    QTJAMBI_TRY{
        ...
        AbstractMapAccess* containerAccess = dynamic_cast<AbstractMapAccess*>(container.second);
        Q_ASSERT(containerAccess);
        result = containerAccess->upperBound(__jni_env, __this_nativeId, container.first, t0);
    }QTJAMBI_CATCH(const JavaException& exn){
        exn.raiseInJava(__jni_env);
    }QTJAMBI_TRY_END
    return result;
