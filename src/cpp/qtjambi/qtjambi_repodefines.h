...
#define QTJAMBI_REPOSITORY_DECLARE_VOID_METHOD(method)\
    ...
    public: static inline void method(JNIEnv* env,jobject object,...){\
        ...
        if(!env->IsInstanceOf(object, _this.class_ref))\
            JavaException::raiseIllegalArgumentException(env, ::QString("Cannot invoke member function %1." #method "(...) on object of type %2.").arg(qtjambi_class_name(env, _this.class_ref), qtjambi_object_class_name(env, object)) QTJAMBI_STACKTRACEINFO );\
        va_list args;\
...
#define QTJAMBI_REPOSITORY_DECLARE_PRIMITIVETYPE_METHOD(jtype,TYPE,method)\
    ...
    public: static inline jtype method(JNIEnv* env,jobject object,...){\
        ...
        if(!env->IsInstanceOf(object, _this.class_ref))\
            JavaException::raiseIllegalArgumentException(env, QLatin1String("Cannot invoke member function %1." #method "(...) on object of type %2.").arg(qtjambi_class_name(env, _this.class_ref), qtjambi_object_class_name(env, object)) QTJAMBI_STACKTRACEINFO );\
        va_list args;\
        va_start(args, object);\
...
#define QTJAMBI_REPOSITORY_DECLARE_PRIMITIVETYPE_FIELD(jtype,TYPE,field)\
    ...
    public: static inline jtype field(JNIEnv* env,jobject object){\
        ...
        if(!env->IsInstanceOf(object, _this.class_ref))\
            JavaException::raiseIllegalArgumentException(env, QLatin1String("Cannot access member field %1." #field " on object of type %2.").arg(qtjambi_class_name(env, _this.class_ref), qtjambi_object_class_name(env, object)) QTJAMBI_STACKTRACEINFO );\
