...
hash_type pointerHashFunction(const void* ptr){ return !ptr ? 0 : qHash(quintptr(*reinterpret_cast<void*const*>(ptr)));}
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
...
hash_type QHashFunction::operator()(const void* ptr) const{
    Q_ASSERT(d);
    return d->invoke(ptr);
}
...
bool QtJambiTypeManager::isQtClass(JNIEnv *env, const QString &className, jobject classLoader) {
    ...
    return (clazz != nullptr && Java::QtJambi::QtJambiInternal::isGeneratedClass(env, clazz));
}
...
bool qtjambi_less_than(JNIEnv *env, jobject k1, jobject k2){
    QVariant v1(qtjambi_to_qvariant(env, k1));
    QVariant v2(qtjambi_to_qvariant(env, k2));
    if(v1.userType()!=QMetaType::UnknownType && v1.userType()==v2.userType()){
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
        if(QtJambiTypeManager::hasRegisteredComparators(v1.userType()))
#else
        const QtPrivate::QMetaTypeInterface *metaTypeInterface = v1.metaType().iface();
        if(metaTypeInterface && metaTypeInterface->lessThan)
#endif
            return v1 < v2;
    }
    if(JNIEnv *env = qtjambi_current_environment()){
        QTJAMBI_JNI_LOCAL_FRAME(env, 300)
        if(Java::QtJambi::QtObjectInterface::isInstanceOf(env, k1) && Java::QtJambi::QtObjectInterface::isInstanceOf(env, k2)){
        ...
        jint h1 = Java::Runtime::Object::hashCode(env, k1);
        jint h2 = Java::Runtime::Object::hashCode(env, k2);
        return h1<h2;
    }
    return false;
}
...
bool QtJambiTypeManager::hasRegisteredComparators(int id){
    return QMetaType::hasRegisteredComparators(id) ||
            ...
            qtjambi_registered_comparator(id);
}
#endif
...
QString QtJambiTypeManager::getInternalTypeName(JNIEnv* env, jclass externalClass, bool useNextSuperclass) {
    ...
    if(Java::Runtime::Void::isPrimitiveType(env, externalClass))
        ...
        QString externalTypeName = qtjambi_class_name(env, externalClass).replace(QLatin1Char('.'), QLatin1Char('/'));
        ...
        if(typeId){
            ...
            QString internalTypeName = QString(externalTypeName).replace(QLatin1String("/"), QLatin1String("::"));
            ...
            internalTypeName = QString(externalTypeName).replace(QLatin1String("/"), QLatin1String("::")) + QLatin1String("&");
            if(QMetaType::type(qPrintable(internalTypeName))!=QMetaType::UnknownType){
                return internalTypeName;
            }
            const SuperTypeInfos& superType = getSuperTypeInfos(env, externalClass);
            ...
            if(Java::Runtime::Map::isAssignableFrom(env, externalClass)){
                return QLatin1String("JMapWrapper");
            }else if(Java::Runtime::Collection::isAssignableFrom(env, externalClass)){
                return QLatin1String("JCollectionWrapper");
            }else if(Java::Runtime::Iterator::isAssignableFrom(env, externalClass)){
                return QLatin1String("JIteratorWrapper");
            }else if(Java::Runtime::Enum::isAssignableFrom(env, externalClass)
                     || Java::QtJambi::QtEnumerator::isAssignableFrom(env, externalClass)
                     || Java::QtJambi::QtLongEnumerator::isAssignableFrom(env, externalClass)
                     || Java::QtJambi::QtShortEnumerator::isAssignableFrom(env, externalClass)
                     || Java::QtJambi::QtByteEnumerator::isAssignableFrom(env, externalClass)){
...
InternalToExternalConverter QtJambiTypeManager::getInternalToExternalConverterImpl(
    ...
    if(isArrayClass && (pointerType==PointerType::initializer_list || internalTypeName.startsWith("initializer_list<"))){
        ...
        jint _internalMetaType = internalMetaType.id();
        return [_internalMetaType](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
            p->l = qtjambi_from_object(env, QMetaType::create(_internalMetaType, in), Java::QtCore::QMetaType$GenericValue::getClass(env), false);
            if(p->l){
        ...
        if(internalMetaType.flags() & QMetaType::PointerToGadget){
            ...
            return [_internalMetaType](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
                p->l = qtjambi_from_object(env, QMetaType::create(_internalMetaType, in), Java::QtCore::QMetaType$GenericGadget::getClass(env), false);
                if(p->l){
                    Java::QtCore::QMetaType$GenericGadget::set_type(env, p->l, _internalMetaType);
                    jobject mo = qtjambi_cast<jobject>(env, QMetaType::metaObjectForType(_internalMetaType));
                    Java::QtJambi::QtGadget::set_staticMetaObject(env, p->l, mo);
        ...
        if(internalTypeName.endsWith("*")){
            return [](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
                if(in){
                    p->l = qtjambi_cast<jobject>(env, **reinterpret_cast<QModelIndex const* const*>(in));
                }
                return true;
            };
        }else{
        ...
        if(internalTypeName.startsWith("QStack<")){
            containerType = ContainerType::QStack;
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
            ...
            containerType = ContainerType::QQueue;
        ...
        if(isPointer){
            ...
            if(t){
                ...
                if(isFunctional(*t)){
                    QString typeName = qtjambi_type_name(*t);
        ...
        if(!clazz.isEmpty()){
            jclass elementClass = resolveClass(_env, clazz);
            if(!containerAccess){
        ...
        if(instantiations.size()==2){
            ...
            if(isPointer1){
                ...
                if(t1){
                    ...
                    if(isFunctional(*t1)){
                        QString typeName = qtjambi_type_name(*t1);
                        if(!typeName.startsWith("std::function") && (typeName.contains("(*)"))){
                            isPointer1 = true;
                            size1 = 0;
                        }
            ...
            if(isPointer2){
                ...
                if(t2){
                    ...
                    if(isFunctional(*t2)){
                        QString typeName = qtjambi_type_name(*t2);
                        if(!typeName.startsWith("std::function") && (typeName.contains("(*)"))){
                            isPointer2 = true;
                            size2 = 0;
                        }
            ...
            if(!clazz1.isEmpty() && !clazz2.isEmpty()){
                jclass keyClass = resolveClass(_env, clazz1);
                ...
                jclass valueClass = resolveClass(_env, clazz2);
                ...
                if(BiContainerAccessFactory accessFactory = ContainerAccessFactories::getAccessFactory(mapType, align1, size1, align2, size2)){
                    ...
                    AbstractContainerAccess* containerAccess = accessFactory(memberMetaType1,
                                                                             hashFunction1,
                                                                             memberConverter1,
                                                                             memberReConverter1,
                                                                             memberMetaType2,
        ...
        return [](JNIEnv*, QtJambiScope*, const void*, jvalue*, bool)->bool{
            return false;
               ...
               bool result = Java::QtJambi::QtJambiInternal::isGeneratedClass(_env, externalClass);
               if(!result){
        ...
        if(typeId){
            ...
            QByteArray className = qtjambi_class_name(_env, externalClass).replace(".", "/").toLatin1();
            if (Java::QtCore::QObject::isAssignableFrom(_env,externalClass)) {
                if(pointerType == PointerType::SharedPointer){
                    return [className](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
                        const QSharedPointer<QObject>* ptr = reinterpret_cast<const QSharedPointer<QObject>*>(in);
                        if(ptr){
                            p->l = qtjambi_from_qobject_shared_pointer(env, className,
                                                                       new QSharedPointer<QObject>(*ptr),
                                                                       &deletePointer<QSharedPointer, QObject>,
                                                                       &getFromPointer<QSharedPointer, QObject>);
                        }
                    ...
                    return [className](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
                        ...
                        if(ptr){
                            QObject * qobject = *ptr;
                            p->l = qtjambi_from_qobject(env, qobject, className);
                        }
                        return true;
                    };
                }
                ...
                return [className](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
                    const std::shared_ptr<void*>* ptr = reinterpret_cast<const std::shared_ptr<void*>*>(in);
                    if(ptr){
                        p->l = qtjambi_from_object_shared_pointer(env, className,
                                                                   new std::shared_ptr<void*>(*ptr),
                                                                   &deletePointer<std::shared_ptr, void*>,
                                                                   &getFromPointer<std::shared_ptr, void*>);
                    }
                ...
                const SuperTypeInfos& superTypes = getSuperTypeInfos(_env, externalClass);
                ...
                if (internalTypeName.contains(QLatin1Char('*')) || forcePointerConversion){
                    ...
                    return [className](JNIEnv* env, QtJambiScope*, const void* in, jvalue* p, bool)->bool{
                        if(in){
                            p->l = qtjambi_from_object(env, in, qPrintable(className), true);
                        }
                        return true;
                    };
                }
...
ExternalToInternalConverter QtJambiTypeManager::getExternalToInternalConverterImpl(JNIEnv* _env, jclass externalClass, QString internalTypeName, const QMetaType& internalMetaType) {
    ...
    if ( internalMetaType.id() == QMetaType::Nullptr
               ...
               || Java::Runtime::Void::isSameClass(_env, externalClass)
               || Java::Runtime::Void::isPrimitiveType(_env, externalClass)) {
        return [](JNIEnv*, QtJambiScope*, const jvalue&, void* &, jValueType) -> bool{
            return true;
        };
    }else if(_env->IsSameObject(externalClass, nullptr)){
        return [](JNIEnv*, QtJambiScope*, const jvalue&, void* &, jValueType) -> bool{
    ...
    if (internalMetaType.id() == QMetaType::QVariant) {
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
            if(scope && !out){
                QVariant* ptr;
    ...
    || internalMetaType.id() == registeredMetaTypeID(typeid(JDoubleArrayWrapper))){
        ...
        if(!internalMetaType.isValid() || internalMetaType==QMetaType::fromType<qint32>() || internalMetaType==QMetaType::fromType<quint32>()){
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l
                        ...
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: int").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            int _internalMetaType = internalMetaType.id();
            return [_internalMetaType](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                jint v;
                switch(valueType){
                case jValueType::l:
                    if(val.l
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l
                        ...
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: long").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l
                            && !Java::Runtime::Byte::isInstanceOf(env, val.l)
                            && !Java::Runtime::Short::isInstanceOf(env, val.l))
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: short").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l && !Java::Runtime::Byte::isInstanceOf(env, val.l))
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: byte").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l && !Java::Runtime::Boolean::isInstanceOf(env, val.l))
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: boolean").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l && !Java::Runtime::Character::isInstanceOf(env, val.l))
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: char").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l
                        ...
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: float").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            ...
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                ...
                case jValueType::l:
                    if(val.l && !Java::Runtime::Number::isInstanceOf(env, val.l))
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: double").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
        ...
        if(!internalMetaType.isValid() || internalMetaType.id()==qMetaTypeId<QString>()){
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                ...
                qtjambi_to_qstring(*reinterpret_cast<QString*>(out), env, strg);
                return true;
            };
        }else{
            int _internalMetaType = internalMetaType.id();
        ...
        if(!internalMetaType.isValid()){
            return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                if(val.l && !Java::QtJambi::QNativePointer::isInstanceOf(env, val.l))
                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: io.qt.QNativePointer").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                if(scope && !out){
                    void** ptr;
            ...
            return [_internalMetaType](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                if(val.l && !Java::QtJambi::QNativePointer::isInstanceOf(env, val.l))
                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: io.qt.QNativePointer").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                void* nptr = !val.l ? nullptr : qtjambi_to_cpointer(env, val.l, 1);
                if(scope && !out){
                    void* ptr;
        ...
        if(internalTypeName.endsWith("&")){
            int _internalMetaType = internalMetaType.id();
            return [_internalMetaType](JNIEnv* env, QtJambiScope*, const jvalue& val, void* &out, jValueType) -> bool{
                if(val.l){
                    if(!Java::QtCore::QMetaType$GenericGadget::isInstanceOf(env, val.l)){
                        ...
                        if(!matches)
                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::QtCore::QMetaType$GenericGadget::getClass(env)).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                    }else{
                        int given = qtjambi_cast<const QMetaType&>(env, Java::QtCore::QMetaType$GenericTypeInterface::metaType(env, val.l)).id();
                        if(_internalMetaType!=given){
                            JavaException::raiseIllegalArgumentException(env, qPrintable(QString("Wrong argument given: %1, expected: %2").arg(QMetaType::typeName(given)).arg(QMetaType::typeName(_internalMetaType))) QTJAMBI_STACKTRACEINFO );
        ...
        if(internalMetaType==QMetaType::fromType<JObjectWrapper>()){
            return [externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                jobject v;
                switch(valueType){
                case jValueType::l:
                        ...
                        *reinterpret_cast<qint32*>(out) = int_for_QtEnumerator_or_QFlags(env, val.l).value<qint32>();
                        ...
                        if(val.l){
                            ...
                            if(!matches && !env->IsInstanceOf(val.l, Java::Runtime::Number::getClass(env)))
                                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg("any number") QTJAMBI_STACKTRACEINFO );
                        }
                        if(scope && !out){
                            qint32* ptr;
                            out = ptr = new qint32;
            ...
            int _internalMetaType = internalMetaType.id();
            return [_internalMetaType, externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
                switch(valueType){
                case jValueType::l:
        ...
        if(internalMetaType==QMetaType::fromType<JEnumWrapper>() || internalMetaType==QMetaType::fromType<JObjectWrapper>()){
                        ...
                        if(Java::QtCore::QMetaType$GenericTypeInterface::isInstanceOf(env,val.l)){
                            ...
                            if(val.l){
                                ...
                                if(!matches
                                    ...
                                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg("any number or enum") QTJAMBI_STACKTRACEINFO );
                                value = int_for_QtEnumerator_or_QFlags(env, val.l);
                            }else{
            ...
            return [externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType valueType) -> bool{
              ...
              || internalTypeName=="QStringList") {
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType t) -> bool{
            if(t!=jValueType::l)
                return false;
            if(val.l && !env->IsInstanceOf(val.l, Java::Runtime::Collection::getClass(env)))
                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::Runtime::Collection::getClass(env))) QTJAMBI_STACKTRACEINFO );
            ...
            if(val.l){
                ...
                while(qtjambi_iterator_has_next(env, iter)){
                    ...
                    if(next && !env->IsInstanceOf(next, Java::QtCore::QByteArray::getClass(env)))
                        Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong collection content given: %1, expected: %2").arg(qtjambi_object_class_name(env, next).replace("$", ".")).arg(qtjambi_class_name(env, Java::QtCore::QByteArray::getClass(env))) QTJAMBI_STACKTRACEINFO );
                    content << next;
                }
            }
            if(scope && !out){
        ...
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType t) -> bool{
            ...
            if(val.l && !env->IsInstanceOf(val.l, Java::Runtime::Map::getClass(env)))
                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::Runtime::Map::getClass(env))) QTJAMBI_STACKTRACEINFO );
        ...
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType t) -> bool{
            ...
            return true;
              ...
              || internalTypeName=="QVariantPair"){
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& in, void* &out, jValueType valueType) -> bool{
            bool response = false;
            if(valueType==jValueType::l){
                if(in.l && !env->IsInstanceOf(in.l, Java::QtCore::QPair::getClass(env)))
                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, in.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::QtCore::QPair::getClass(env)).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                if(!out){
                    if(scope){
        ...
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
            if(val.l && !env->IsInstanceOf(val.l, Java::QtCore::QMetaObject::getClass(env)))
                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::QtCore::QMetaObject::getClass(env))) QTJAMBI_STACKTRACEINFO );
            if(scope && !out){
                QMetaObject** ptr;
        ...
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
            if(val.l && !env->IsInstanceOf(val.l, Java::QtCore::QMetaObject$Connection::getClass(env)))
                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::QtCore::QMetaObject$Connection::getClass(env)).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            if(scope && !out){
    ...
    }else if (Java::QtCore::QModelIndex::isAssignableFrom(_env,externalClass) && (!internalMetaType.isValid() || QByteArray("QModelIndex")==internalMetaType.name())) {
        return [](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
            if(val.l && !env->IsInstanceOf(val.l, Java::QtCore::QModelIndex::getClass(env)))
                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::QtCore::QModelIndex::getClass(env)).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
            if(scope && !out){
                QModelIndex* ptr;
        ...
        if(const std::type_info* typeId = getTypeByQtName(_internalTypeName)){
            ...
            if(size>0){
                if(Java::Runtime::Byte::isPrimitiveType(_env,componentClass)){
                    return [](JNIEnv* env, QtJambiScope* scope, const jvalue& in, void* &out, jValueType) -> bool {
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Byte::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: byte[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Short::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: short[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Integer::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: int[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Long::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: long[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Float::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: float[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Double::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: double[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Character::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: char[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
                                ...
                                if(scope){
                                    if(in.l){
                                        ...
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !Java::Runtime::Boolean::isPrimitiveType(env, Java::Runtime::Class::getComponentType(env, objectClass)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: boolean[]").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                    ...
                    ExternalToInternalConverter externalToInternalComponentConverter = getExternalToInternalConverter(
                                                                    ...
                                                                    _internalTypeName,
                                                                    _metaType);
                    return [size, externalToInternalComponentConverter, componentClass](JNIEnv* env, QtJambiScope* scope, const jvalue& in, void* &out, jValueType) -> bool {
                                if(scope){
                                    if(in.l){
                                        jclass objectClass = env->GetObjectClass(in.l);
                                        if(!Java::Runtime::Class::isArray(env, objectClass) || !env->IsAssignableFrom(Java::Runtime::Class::getComponentType(env, objectClass), componentClass))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Object of type %1 not allowed. Array expected.").arg(qtjambi_class_name(env, objectClass)) QTJAMBI_STACKTRACEINFO );
                                        if(!out){
        ...
        if(const QMetaObject* metaObject = internalMetaType.metaObject()){
            if(metaObject->inherits(&QObject::staticMetaObject)){
                int _internalMetaType = internalMetaType.id();
                return [metaObject,_internalMetaType, externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                    if(Java::QtCore::QMetaType$GenericTypeInterface::isInstanceOf(env,val.l)){
                        int given = qtjambi_cast<const QMetaType&>(env, Java::QtCore::QMetaType$GenericTypeInterface::metaType(env, val.l)).id();
                        if(_internalMetaType!=given){
                            JavaException::raiseIllegalArgumentException(env, qPrintable(QString("Wrong argument given: %1, expected: %2").arg(QMetaType::typeName(given)).arg(QMetaType::typeName(_internalMetaType))) QTJAMBI_STACKTRACEINFO );
        ...
        if( (internalTypeName.startsWith("QVector<")
            ...
            if(!clazz.isEmpty()){
                ...
                switch(containerType){
                case ContainerType::QSet:
                    isContainerFunction = qtjambi_is_QSet;
                ...
                case ContainerType::QVector:
                    ...
                    break;
                case ContainerType::QLinkedList:
                    isContainerFunction = qtjambi_is_QLinkedList;
                    containerAppendFunction = [](AbstractContainerAccess* access, JNIEnv * env, void* container, jobject value){
                ...
                if(containerAccess){
                    ...
                    return [sharedAccess,
                            ...
                            elementClass,
                            memberMetaType,
                            isContainerFunction](JNIEnv* env, QtJambiScope* scope, const jvalue& in, void* &out, jValueType valueType) -> bool{
                        bool response = false;
                        if(valueType==jValueType::l){
                            if(in.l && !env->IsInstanceOf(in.l, Java::Runtime::Collection::getClass(env)))
                                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, in.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::Runtime::Collection::getClass(env)).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                            ...
                            if(!in.l){
                                ...
                                if(out){
                                    QList<jobject> content;
                                    jobject iterator = qtjambi_collection_iterator(env, in.l);
                ...
                if(!clazz1.isEmpty() && !clazz2.isEmpty()){
                    ...
                    if(BiContainerAccessFactory accessFactory = ContainerAccessFactories::getAccessFactory(mapType, align1, size1, align2, size2)){
                        ...
                        if(containerAccess){
                            ...
                            if(mapType==MapType::QPair){
                                QSharedPointer<AbstractPairAccess> pairAccess(sharedAccess.dynamicCast<AbstractPairAccess>());
                                return [pairAccess,keyClass,valueClass](JNIEnv* env, QtJambiScope* scope, const jvalue& in, void* &out, jValueType valueType) -> bool{
                                    bool response = false;
                                    if(valueType==jValueType::l){
                                        ...
                                        if(in.l){
                                            if(!env->IsInstanceOf(in.l, Java::QtCore::QPair::getClass(env)))
                                                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: QPair<%2,%3>").arg(qtjambi_object_class_name(env, in.l).replace("$", ".")).arg(qtjambi_class_name(env, keyClass).replace("$", ".")).arg(qtjambi_class_name(env, valueClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                            first = Java::QtCore::QPair::first(env, in.l);
                                            second = Java::QtCore::QPair::second(env, in.l);
                                            if(first && !env->IsInstanceOf(first, keyClass))
                                                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong QPair.first given: %1, expected: %2").arg(qtjambi_object_class_name(env, first).replace("$", ".")).arg(qtjambi_class_name(env, keyClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                            if(second && !env->IsInstanceOf(second, valueClass))
                                                Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong QPair.second given: %1, expected: %2").arg(qtjambi_object_class_name(env, second).replace("$", ".")).arg(qtjambi_class_name(env, valueClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                        }
                                        if(!out){
                                            if(scope){
                                ...
                                IsBiContainerFunction isContainerFunction = qtjambi_is_QMap;
                                ...
                                switch(mapType){
                                case MapType::QMultiMap:
                                    isContainerFunction = qtjambi_is_QMultiMap;
                                    containerInsertFunction = [](AbstractContainerAccess* access, JNIEnv * env, void* container, jobject key, jobject value){
                                        jobject iterator = qtjambi_collection_iterator(env, value);
                                        QList<jobject> values;
                                        while(qtjambi_iterator_has_next(env, iterator)) {
                                            jobject val = qtjambi_iterator_next(env, iterator);
                                            values.prepend(val);
                                        }
                                    ...
                                    break;
                                case MapType::QMultiHash:
                                    isContainerFunction = qtjambi_is_QMultiHash;
                                    containerInsertFunction = [](AbstractContainerAccess* access, JNIEnv * env, void* container, jobject key, jobject value){
                                        jobject iterator = qtjambi_collection_iterator(env, value);
                                        QList<jobject> values;
                                        while(qtjambi_iterator_has_next(env, iterator)) {
                                    ...
                                    break;
                                case MapType::QHash:
                                    isContainerFunction = qtjambi_is_QHash;
                                    containerInsertFunction = [](AbstractContainerAccess* access, JNIEnv * env, void* container, jobject key, jobject value){
                                ...
                                return [sharedAccess,
                                    ...
                                    if(valueType==jValueType::l){
                                        if(in.l && !env->IsInstanceOf(in.l, Java::Runtime::Map::getClass(env)))
                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, in.l).replace("$", ".")).arg(qtjambi_class_name(env, Java::Runtime::Map::getClass(env)).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                        bool deleteAccess = true;
                                        ...
                                        if(!in.l){
                                            ...
                                            if(out){
                                                QList<jobject> content;
                                                if(in.l){
                                                    jobject iter = qtjambi_map_entryset_iterator(env, in.l);
                                                    while(qtjambi_iterator_has_next(env, iter)){
                                                        jobject next = qtjambi_iterator_next(env, iter);
                                                        jobject key = qtjambi_map$entry_key(env, next);
                                                        jobject value = qtjambi_map$entry_value(env, next);
                                                        if(key && !env->IsInstanceOf(key, keyClass))
                                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong map key given: %1, expected: %2").arg(qtjambi_object_class_name(env, key).replace("$", ".")).arg(qtjambi_class_name(env, keyClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                                        if(value && !env->IsInstanceOf(value, valueClass))
                                                            Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong map value given: %1, expected: %2").arg(qtjambi_object_class_name(env, value).replace("$", ".")).arg(qtjambi_class_name(env, valueClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                                        content << next;
                                                    }
                                                }
                                                for(const QSharedPointer<QtJambiLink>& link : QtJambiLink::findLinksForPointer(out)){
            ...
            if(typeId){
                ...
                if(internalTypeName.endsWith("&") || !(isValue || isPointer || internalTypeName.endsWith("*") || isQmlList)){
                    if(isInterface){
                        return [typeId, externalClass](JNIEnv* env, QtJambiScope*, const jvalue& val, void* &out, jValueType) -> bool{
                            if(val.l){
                                if(!env->IsInstanceOf(val.l, externalClass))
                                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, externalClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                        ...
                        return [typeId, externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                            if(val.l){
                                if(!env->IsInstanceOf(val.l, externalClass))
                                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, externalClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                if(const QSharedPointer<QtJambiLink>& link = QtJambiLink::findLinkForJavaInterface(env, val.l)){
                        ...
                        return [externalClass](JNIEnv* env, QtJambiScope*, const jvalue& val, void* &out, jValueType) -> bool{
                            if(val.l){
                                if(!env->IsInstanceOf(val.l, externalClass))
                                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, externalClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
                                if(const QSharedPointer<QtJambiLink>& link = QtJambiLink::findLinkForJavaObject(env, val.l)){
                    ...
                    if(isInterface){
                        return [_internalMetaType, typeId, externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                            void* ptr = nullptr;
                            if(val.l){
                                if(Java::QtCore::QMetaType$GenericTypeInterface::isInstanceOf(env,val.l)){
                                    int given = qtjambi_cast<const QMetaType&>(env, Java::QtCore::QMetaType$GenericTypeInterface::metaType(env, val.l)).id();
                    ...
                    if(isInterface){
                        ...
                        return [externalClass](JNIEnv* env, QtJambiScope* scope, const jvalue& val, void* &out, jValueType) -> bool{
                            void* ptr = nullptr;
                            if(val.l){
                                if(!env->IsInstanceOf(val.l, externalClass))
                                    Java::Runtime::IllegalArgumentException::throwNew(env, QString("Wrong argument given: %1, expected: %2").arg(qtjambi_object_class_name(env, val.l).replace("$", ".")).arg(qtjambi_class_name(env, externalClass).replace("$", ".")) QTJAMBI_STACKTRACEINFO );
...
QDebug containerElementDebugStream(QDebug debug, uint i, const void* ptr)
{
    ...
    Q_ASSERT(metaData.metaType.isValid());
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
    if(!QMetaType::debugStream(debug, ptr, metaData.metaType.id())){
#else
...
hash_type containerElementHash(uint i, const void* ptr)
{
    const MetaData& metaData = currentMetaData(i);
...
bool containerElementEqual(uint i, const void* ptr, const void* ptr2)
{
...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
    int result = -1;
    if(QMetaType::equals(ptr, ptr2, metaData.metaType.id(), &result))
        return result==0;
    const QtPrivate::AbstractComparatorFunction * comparator = qtjambi_registered_comparator(metaData.metaType.id());
    if(comparator){
    ...
    if(metaData.metaType.id()<QMetaType::User)
        return QVariant(metaData.metaType.id(), ptr)==QVariant(metaData.metaType.id(), ptr2);
    if(metaData.metaType.flags() & QMetaType::IsEnumeration){
        switch(metaData.metaType.sizeOf()){
...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
    int result = -1;
    if(QMetaType::compare(ptr, ptr2, metaData.metaType.id(), &result))
        return result<0;
    const QtPrivate::AbstractComparatorFunction * comparator = qtjambi_registered_comparator(metaData.metaType.id());
...
QMetaType::Destructor wrapDestructor(int metaType,
                                    ...
                                    QMetaType::Destructor destructor,
                                    uint hash){
    return qtjambi_function_pointer<64,void(void*)>([index, metaType, hashFunction, destructor](void * ptr){
...
QMetaType::Constructor wrapConstructor(int metaType,
    ...
    return qtjambi_function_pointer<64,void*(void*, const void *)>([index, metaType, hashFunction, constructor](void *where, const void * copy)->void *{
...
QMetaType::SaveOperator wrapSaveOperator(int metaType,
    ...
    return qtjambi_function_pointer<64,void(QDataStream &, const void *)>([index, metaType, hashFunction, saveOperator](QDataStream & stream, const void * data){
...
QMetaType::LoadOperator wrapLoadOperator(int metaType,
    ...
    return qtjambi_function_pointer<64,void(QDataStream &, void *)>([index, metaType, hashFunction, saveOperator](QDataStream & stream, void * data){
...
QMetaType::Destructor wrapDestructor(int metaType1,
                                    ...
                                    QMetaType::Destructor destructor,
                                    uint hash){
    return qtjambi_function_pointer<64,void(void*)>([metaType1, hashFunction1,
...
QMetaType::Constructor wrapConstructor(int metaType1,
                                      ...
                                      QHashFunction hashFunction2,
                                      QMetaType::Constructor constructor, uint hash){
    return qtjambi_function_pointer<64,void*(void*, const void *)>([metaType1, hashFunction1,
                                                                                         metaType2, hashFunction2,
...
QMetaType::SaveOperator wrapSaveOperator(int metaType1,
                                         ...
                                         QHashFunction hashFunction2,
                                         QMetaType::SaveOperator saveOperator, uint hash){
    return qtjambi_function_pointer<64,void(QDataStream &, const void *)>([metaType1, hashFunction1, metaType2, hashFunction2, saveOperator](QDataStream & stream, const void * data){
...
QMetaType::LoadOperator wrapLoadOperator(int metaType1,
                                         ...
                                         QHashFunction hashFunction2,
                                         QMetaType::LoadOperator saveOperator, uint hash){
    return qtjambi_function_pointer<64,void(QDataStream &, void *)>([metaType1, hashFunction1, metaType2, hashFunction2, saveOperator](QDataStream & stream, void * data){
...
int qtjambi_register_container_type(const QByteArray& typeName, size_t containerSize, size_t containerAlign, bool isPointer, const QMetaType& metaType,
                                      QMetaType::Destructor destructor,
                                    ...
                                    HashWrapper hashWrapper)
{
    ...
    if(QtJambiTypeManager::hasRegisteredComparators(metaType.id()))
        qtjambi_register_comparator(comparator, newMetaType);
    ...
    if(!QMetaType::hasRegisteredConverterFunction(newMetaType, qMetaTypeId<QtMetaTypePrivate::QSequentialIterableImpl>()))
        qtjambi_register_converter(createConverterFunction(metaType.id()), newMetaType, qMetaTypeId<QtMetaTypePrivate::QSequentialIterableImpl>());
    if(debugStreamFunction && debugStreamFunction->stream){
        ...
        qtjambi_register_debugstream_operator(new DebugStreamFunction(metaType.id(), hashFunction, debugStreamFunction), newMetaType);
    }
    if(!hashFunctionByMetaType(newMetaType)){
        ...
        insertHashFunctionByMetaType(newMetaType,
                                            ...
                                            (const void* ptr)->hash_type{
                                                if(ptr){
                                                    MetaData oldMetaData = currentMetaData(0);
                                                    setCurrentMetaData(0, MetaData(_metaType, hashFunction));
                                                    hash_type result = hashWrapper(ptr, hashFunction);
                                                    setCurrentMetaData(0, oldMetaData);
                                                    return result;
                                                }else{
                                                    return 0;
...
int qtjambi_register_bicontainer_type(const QByteArray& typeName,
                                      ...
                                      HashWrapper2 hashWrapper)
{
    ...
    if(!QMetaType::hasRegisteredConverterFunction(newMetaType, isPair ? qMetaTypeId<QtMetaTypePrivate::QPairVariantInterfaceImpl>() : qMetaTypeId<QtMetaTypePrivate::QAssociativeIterableImpl>()))
        qtjambi_register_converter(createConverterFunction(metaType1.id(), metaType2.id()), newMetaType, isPair ? qMetaTypeId<QtMetaTypePrivate::QPairVariantInterfaceImpl>() : qMetaTypeId<QtMetaTypePrivate::QAssociativeIterableImpl>());
    if(saveOperator && loadOperator)
        QMetaType::registerStreamOperators(newMetaType, saveOperator, loadOperator);
    if(debugStreamFunction && debugStreamFunction->stream){
        struct DebugStreamFunction : QtPrivate::AbstractDebugStreamFunction{
        ...
        qtjambi_register_debugstream_operator(new DebugStreamFunction(metaType1.id(), hashFunction1, metaType2.id(), hashFunction2, debugStreamFunction), newMetaType);
    }
    if(!hashFunctionByMetaType(newMetaType)){
        ...
        insertHashFunctionByMetaType(newMetaType,
                                            ...
                                            (const void* ptr)->hash_type{
                                                if(ptr){
                                                    ...
                                                    hash_type result = hashWrapper(ptr, hashFunction1, hashFunction2);
                                                    setCurrentMetaData(0, oldMetaData1);
                                                    setCurrentMetaData(1, oldMetaData2);
                                                    return result;
                                                }else{
...
void qtjambi_container_default_construct(const QtPrivate::QMetaTypeInterface * metaTypeInterface, void *where){
    if(gContainerInfos->contains(metaTypeInterface)){
        const ContainerInfo& info = (*gContainerInfos)[metaTypeInterface];
        if(info.isPointer){
...
bool qtjambi_container_lessThan(const QtPrivate::QMetaTypeInterface * metaTypeInterface, const void *container1, const void *container2){
    if(gContainerInfos->contains(metaTypeInterface)){
        const ContainerInfo& info = (*gContainerInfos)[metaTypeInterface];
        if(info.lessThan){
            if(info.isPointer){
...
const QtMetaContainerPrivate::QMetaAssociationInterface& qtjambi_find_meta_association(QMetaType keyMetaType, QMetaType valueMetaType, const QtMetaContainerPrivate::QMetaAssociationInterface& defaultInterface)
{
    hash_type hash = hashSum({qHash(quintptr(&defaultInterface)), qHash(keyMetaType.id()), qHash(valueMetaType.id())});
    {
        QReadLocker locker(gCacheLock());
        Q_UNUSED(locker)
    ...
    }
    {
        ...
        d.keyMetaType = keyMetaType.iface();
        d.mappedMetaType = valueMetaType.iface();
...
{
    QHashFunction hashFunction = QtJambiTypeManager::findHashFunction(isPointer, metaType.id());
    if(!const_cast<QMetaType&>(metaType).iface()->defaultCtr)
        defaultCtr = nullptr;
    if(!const_cast<QMetaType&>(metaType).iface()->copyCtr)
        copyCtr = nullptr;
    if(!const_cast<QMetaType&>(metaType).iface()->moveCtr)
        moveCtr = nullptr;
    if(!const_cast<QMetaType&>(metaType).iface()->dtor)
        dtor = nullptr;
    if(!const_cast<QMetaType&>(metaType).iface()->equals)
        equals = nullptr;
    if(!const_cast<QMetaType&>(metaType).iface()->lessThan)
        lessThan = nullptr;
    ...
    QMetaType _newMetaType = createMetaType(typeName,
                                            true,
                                            /*.defaultCtr=*/ defaultCtr ? &qtjambi_container_default_construct : nullptr,
                                            ...
                                            /*.lessThan=*/ lessThan ? &qtjambi_container_lessThan : nullptr,
                                      ...
                                      HashWrapper2 hashWrapper)
{
    QHashFunction hashFunction1 = QtJambiTypeManager::findHashFunction(isPointer1, metaType1.id());
    QHashFunction hashFunction2 = QtJambiTypeManager::findHashFunction(isPointer2, metaType2.id());
    if(!const_cast<QMetaType&>(metaType1).iface()->defaultCtr || !const_cast<QMetaType&>(metaType2).iface()->defaultCtr)
        defaultCtr = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->copyCtr || !const_cast<QMetaType&>(metaType2).iface()->copyCtr)
        copyCtr = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->moveCtr || !const_cast<QMetaType&>(metaType2).iface()->moveCtr)
        moveCtr = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->dtor || !const_cast<QMetaType&>(metaType2).iface()->dtor)
        dtor = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->equals || !const_cast<QMetaType&>(metaType2).iface()->equals)
        equals = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->lessThan || !const_cast<QMetaType&>(metaType2).iface()->lessThan)
        lessThan = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->debugStream || !const_cast<QMetaType&>(metaType2).iface()->debugStream)
        debugStream = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->dataStreamIn || !const_cast<QMetaType&>(metaType2).iface()->dataStreamIn)
        dataStreamIn = nullptr;
    if(!const_cast<QMetaType&>(metaType1).iface()->dataStreamOut || !const_cast<QMetaType&>(metaType2).iface()->dataStreamOut)
        dataStreamOut = nullptr;
    QMetaType _newMetaType = createMetaType(typeName,
                                            true,
                                            /*.defaultCtr=*/ defaultCtr ? &qtjambi_container_default_construct : nullptr,
    ...
    if(createMetaAssociationIterator){
        if(defaultInterface){
            ...
            if (createMetaAssociationConstIterator && !QMetaType::hasRegisteredConverterFunction(_newMetaType, to)) {
                ...
                QMetaType::registerConverterFunction([_metaType1, _metaType2, defaultInterface, createMetaAssociationConstIterator](const void *src, void *target) -> bool {
                    const QtMetaContainerPrivate::QMetaAssociationInterface &d = qtjambi_find_meta_association(_metaType1, _metaType2, *defaultInterface);
            ...
            if (createMetaAssociationIterator && !QMetaType::hasRegisteredMutableViewFunction(_newMetaType, to)) {
                QMetaType _metaType1 = metaType1;
                QMetaType _metaType2 = metaType2;
                QMetaType::registerMutableViewFunction([_metaType1,_metaType2, defaultInterface, createMetaAssociationIterator](void *src, void *target) -> bool {
                    const QtMetaContainerPrivate::QMetaAssociationInterface &d = qtjambi_find_meta_association(_metaType1, _metaType2, *defaultInterface);
...
QHashFunction QtJambiTypeManager::findHashFunction(bool isPointer, int metaType)
{
    if(isPointer){
        ...
        if(typeId){
            return registeredHashFunction(*typeId);
        }
        return hashFunctionByMetaType(metaType);
    }
}
