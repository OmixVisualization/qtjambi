#ifndef QTJAMBI_CAST_CONTAINER5_P_H
#define QTJAMBI_CAST_CONTAINER5_P_H
...
struct qtjambi_jnitype_container5_cast{
...
template<bool has_scope,
         ...
         typename K, typename T, typename A, typename B, typename C>
struct qtjambi_jnitype_container5_cast<true, has_scope,
                                 jobject,
...
template<bool has_scope,
         bool is_pointer, bool is_const, bool is_reference,
         typename K, typename T, typename A, typename B, typename C>
struct qtjambi_jnitype_container5_cast<false, has_scope,
                                 jobject,
                                 std::unordered_map, is_pointer, is_const, is_reference,
                                 K, T, A, B, C>{
    typedef std::unordered_map<K, T, A, B, C> NativeType;
...
#endif // QTJAMBI_CAST_CONTAINER5_P_H
