TARGET = org_qtjambi_qt3d_renderer_quick

greaterThan(QT_MAJOR_VERSION, 4): VERSION = $$QT_VERSION

include(../qtjambi/qtjambi_include.pri)
include($$QTJAMBI_CPP/org_qtjambi_qt3d_renderer_quick/org_qtjambi_qt3d_renderer_quick.pri)
...
QT += core gui qml 3dcore 3drenderer 3dquick 3dquickrenderer

DEPENDPATH += $$(QTDIR)/include/Qt3DQuickRenderer/$$QT_VERSION
DEPENDPATH += $$(QTDIR)/include/Qt3DQuickRenderer/$$QT_VERSION/Qt3DQuickRenderer
DEPENDPATH += $$(QTDIR)/include/Qt3DQuickRenderer/$$QT_VERSION/Qt3DQuickRenderer/private
DEPENDPATH += $$PWD

INCLUDEPATH += $$(QTDIR)/include/Qt3DQuickRenderer/$$QT_VERSION
INCLUDEPATH += $$(QTDIR)/include/Qt3DQuickRenderer/$$QT_VERSION/Qt3DQuickRenderer
INCLUDEPATH += $$(QTDIR)/include/Qt3DQuickRenderer/$$QT_VERSION/Qt3DQuickRenderer/private
INCLUDEPATH += $$PWD
