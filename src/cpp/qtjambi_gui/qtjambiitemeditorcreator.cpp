...
public:
    ...
    {
        m_constructor = env->GetMethodID(m_widget_type, "<init>", "(Lorg/qtjambi/qt/gui/QWidget;)V");
    }
...
extern "C" JNIEXPORT void JNICALL QTJAMBI_FUNCTION_PREFIX(Java_org_qtjambi_qt_gui_QItemEditorCreator__1_1qt_1QItemEditorCreator)
(JNIEnv *__jni_env,
 ...
 jboolean valuePropertyNameOverride)
{
    ...
    QtJambiLink *__qt_java_link = qtjambi_construct_object(__jni_env, __jni_object, __qt_this, QMetaType::Void, QLatin1String("org/qtjambi/qt/gui/QItemEditorCreator"), true);
    if (!__qt_java_link) {
...
extern "C" JNIEXPORT jobject JNICALL QTJAMBI_FUNCTION_PREFIX(Java_org_qtjambi_qt_gui_QItemEditorCreator__1_1qt_1createWidget)
(JNIEnv *__jni_env,
 jobject ,
 jlong nativeId,
 jlong parentId)
...
extern "C" JNIEXPORT jobject JNICALL QTJAMBI_FUNCTION_PREFIX(Java_org_qtjambi_qt_gui_QItemEditorCreator__1_1qt_1valuePropertyName)
(JNIEnv *__jni_env,
 jobject ,
 jlong nativeId)
{
...
extern "C" JNIEXPORT void JNICALL QTJAMBI_FUNCTION_PREFIX(Java_org_qtjambi_qt_gui_QStandardItemEditorCreator__1_1qt_1QStandardItemEditorCreator)
(JNIEnv *__jni_env,
 jobject __jni_object,
 jclass widgetType,
 jboolean createWidgetOverride,
 jboolean valuePropertyNameOverride)
{
    QtJambiStandardItemEditorCreator *__qt_this = new QtJambiStandardItemEditorCreator(__jni_env, widgetType,
        bool(createWidgetOverride), bool(valuePropertyNameOverride));
    QtJambiLink *__qt_java_link = qtjambi_construct_object(__jni_env, __jni_object, __qt_this, QMetaType::Void, QLatin1String("org/qtjambi/qt/gui/QStandardItemEditorCreator"), true);
    if (!__qt_java_link) {
...
extern "C" JNIEXPORT jobject JNICALL QTJAMBI_FUNCTION_PREFIX(Java_org_qtjambi_qt_gui_QStandardItemEditorCreator__1_1qt_1createWidget)
(JNIEnv *__jni_env,
 jobject ,
 jlong nativeId,
 jlong parentId)
...
extern "C" JNIEXPORT jobject JNICALL QTJAMBI_FUNCTION_PREFIX(Java_org_qtjambi_qt_gui_QStandardItemEditorCreator__1_1qt_1valuePropertyName)
(JNIEnv *__jni_env,
 jobject ,
 jlong nativeId)
{
