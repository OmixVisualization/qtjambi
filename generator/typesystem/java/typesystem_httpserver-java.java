...
class QHttpServer___{
    ...
    @io.qt.QtUninvokable
    public void afterRequest(java.util.function.BiFunction<QHttpServerResponse,QHttpServerRequest,QHttpServerResponse> action) {
	...
	protected boolean handleRequest(QHttpServerRequest request, io.qt.network.QTcpSocket socket) {
		return handleRequest(QtJambi_LibraryUtilities.internal.nativeId(this), QtJambi_LibraryUtilities.internal.checkedNativeId(request), QtJambi_LibraryUtilities.internal.nativeId(socket));
	}
	...
	private void sendResponse(QHttpServerResponse response, QHttpServerRequest request, io.qt.network.QTcpSocket socket){
		sendResponse(QtJambi_LibraryUtilities.internal.nativeId(this), QtJambi_LibraryUtilities.internal.checkedNativeId(response), QtJambi_LibraryUtilities.internal.checkedNativeId(request), QtJambi_LibraryUtilities.internal.nativeId(socket));
	}
    ...
    private Object[] values(io.qt.core.QRegularExpressionMatch rem, io.qt.core.QMetaType[] metaTypes, Object... requestResponder) {
	...
	@io.qt.QtUninvokable
	private QHttpServerRouterRule.RouterHandler createRouterHandler(GenericViewHandler viewHandler, io.qt.core.QMetaType... metaTypes){
	...
	@io.qt.QtUninvokable
	private <R> QHttpServerRouterRule.RouterHandler createRouterHandler(java.util.function.BiFunction<Object[], QHttpServerRequest, R> viewHandler, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
			Object[] values = values(rem, metaTypes);
	...
	@io.qt.QtUninvokable
	private <R> QHttpServerRouterRule.RouterHandler createRouterHandler(java.util.function.Function<Object[], R> viewHandler, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
			Object[] values = values(rem, metaTypes);
	...
	@io.qt.QtUninvokable
	private QHttpServerRouterRule.RouterHandler createRouterHandler(java.util.function.BiConsumer<Object[], QHttpServerResponder> viewHandler, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
			Object[] values = values(rem, metaTypes);
	...
	@io.qt.QtUninvokable
	private <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> QHttpServerRouterRule.RouterHandler createRouterHandlerResponder(ViewHandler viewHandler, SlotInvoker<ViewHandler> slotInvoker, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
	...
	@io.qt.QtUninvokable
	private <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> QHttpServerRouterRule.RouterHandler createRouterHandlerRequestResponder(ViewHandler viewHandler, SlotInvoker<ViewHandler> slotInvoker, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
	...
	@io.qt.QtUninvokable
	private <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> QHttpServerRouterRule.RouterHandler createRouterHandlerResponderRequest(ViewHandler viewHandler, SlotInvoker<ViewHandler> slotInvoker, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
	...
	@io.qt.QtUninvokable
	private <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> QHttpServerRouterRule.RouterHandler createRouterHandlerRequest(ViewHandler viewHandler, SlotInvoker<ViewHandler> slotInvoker, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
	...
	@io.qt.QtUninvokable
	private <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> QHttpServerRouterRule.RouterHandler createRouterHandler(ViewHandler viewHandler, SlotInvoker<ViewHandler> slotInvoker, io.qt.core.QMetaType... metaTypes){
		return (rem, request, socket)->{
				Object[] values = values(rem, metaTypes);
				Object result;
				try {
    ...
    public boolean route(String pathPattern, GenericViewHandler viewHandler, io.qt.core.QMetaType... metaTypes) {
    	if(pathPattern==null || viewHandler==null || metaTypes==null)
    		return false;
    	return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandler(viewHandler, metaTypes)), metaTypes);
    }
	
	@io.qt.QtUninvokable
	public boolean route(java.util.function.Function<io.qt.httpserver.QHttpServerRouterRule.RouterHandler, QHttpServerRouterRule> ruleFactory, GenericViewHandler viewHandler, io.qt.core.QMetaType... metaTypes) {
    ...
    @io.qt.QtUninvokable
    public boolean route(String pathPattern, io.qt.httpserver.QHttpServerRequest.Methods methods, GenericViewHandler viewHandler, io.qt.core.QMetaType... metaTypes) {
    	if(pathPattern==null || viewHandler==null || metaTypes==null)
    		return false;
    ...
    @io.qt.QtUninvokable
    public <R> boolean route(String pathPattern, java.util.function.BiFunction<Object[], QHttpServerRequest, R> viewHandler, io.qt.core.QMetaType... metaTypes) {
    	if(pathPattern==null || viewHandler==null || metaTypes==null)
    		return false;
    	return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandler(viewHandler, metaTypes)), metaTypes);
    }
	...
	@io.qt.QtUninvokable
	public boolean route(java.util.function.Function<io.qt.httpserver.QHttpServerRouterRule.RouterHandler, QHttpServerRouterRule> ruleFactory, java.util.function.BiConsumer<Object[], QHttpServerResponder> viewHandler, io.qt.core.QMetaType... metaTypes) {
		if(viewHandler==null || metaTypes==null)
			return false;
		return router().addRule(ruleFactory.apply(createRouterHandler(viewHandler, metaTypes)), metaTypes);
	}
    ...
    @io.qt.QtUninvokable
    public boolean route(String pathPattern, java.util.function.BiConsumer<Object[], QHttpServerResponder> viewHandler, io.qt.core.QMetaType... metaTypes) {
    	if(pathPattern==null || viewHandler==null || metaTypes==null)
    		return false;
    	return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandler(viewHandler, metaTypes)), metaTypes);
    }
    ...
    @io.qt.QtUninvokable
    public boolean route(String pathPattern, io.qt.httpserver.QHttpServerRequest.Methods methods, java.util.function.BiConsumer<Object[], QHttpServerResponder> viewHandler, io.qt.core.QMetaType... metaTypes) {
    	if(pathPattern==null || viewHandler==null || metaTypes==null)
    		return false;
    	return router().addRule(new QHttpServerRouterRule(pathPattern, methods, createRouterHandler(viewHandler, metaTypes)), metaTypes);
    }
    ...
    @io.qt.QtUninvokable
    public <R> boolean route(String pathPattern, java.util.function.Function<Object[], R> viewHandler, io.qt.core.QMetaType... metaTypes) {
    	if(pathPattern==null || viewHandler==null || metaTypes==null)
    		return false;
    	return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandler(viewHandler, metaTypes)), metaTypes);
    }
	...
	private <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> InvokableTypeInfo<ViewHandler> type(ViewHandler slot){
    	...
    	if(slot instanceof io.qt.core.QMetaObject.Slot0) {
    		...
    		info.slotInvoker = (object, args) -> {
    			((io.qt.core.QMetaObject.Slot7)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
    			return null;
    		};
    	}else if(slot instanceof io.qt.core.QMetaObject.Slot8) {
    		info.slotInvoker = (object, args) -> {
    			((io.qt.core.QMetaObject.Slot8)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]);
    			return null;
    		};
    	}else if(slot instanceof io.qt.core.QMetaObject.Slot9) {
    		info.slotInvoker = (object, args) -> {
    			((io.qt.core.QMetaObject.Slot9)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
    			return null;
    		};
    		...
    		info.slotInvoker = (object, args) -> {
    			return ((io.qt.core.QMetaObject.Method6)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5]);
    		};
    	}else if(slot instanceof io.qt.core.QMetaObject.Method7) {
    		info.slotInvoker = (object, args) -> {
    			return ((io.qt.core.QMetaObject.Method7)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
    		};
    	}else if(slot instanceof io.qt.core.QMetaObject.Method8) {
    		info.slotInvoker = (object, args) -> {
    			return ((io.qt.core.QMetaObject.Method8)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]);
    		};
    	}else if(slot instanceof io.qt.core.QMetaObject.Method9) {
    		info.slotInvoker = (object, args) -> {
    			return ((io.qt.core.QMetaObject.Method9)object).invoke(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
    		};
    	}
    	return info;
    }
	...
	@io.qt.QtUninvokable
    public <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> boolean route(String pathPattern, ViewHandler viewHandler) {
		...
		if(!info.hasReturnType) { // no responder!
			...
			if(requestArg==-1) {
				return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandlerResponder(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}else if(requestArg<responderArg){
				return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandlerRequestResponder(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}else {
				return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandlerResponderRequest(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}
		}else {
			if(responderArg>0) {
			...
			if(requestArg==-1) {
				return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandler(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}else {
				return router().addRule(new QHttpServerRouterRule(pathPattern, createRouterHandlerRequest(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}
		}
    }
	
	@io.qt.QtUninvokable
    public <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> boolean route(java.util.function.Function<io.qt.httpserver.QHttpServerRouterRule.RouterHandler, QHttpServerRouterRule> ruleFactory, ViewHandler viewHandler) {
		InvokableTypeInfo<ViewHandler> info = type(viewHandler);
    	if(info.slotInvoker==null)
    		return false;
		java.lang.reflect.Parameter[] parameters = info.parameters;
		...
		if(!info.hasReturnType) { // no responder!
			...
			if(requestArg==-1) {
				return router().addRule(ruleFactory.apply(createRouterHandlerResponder(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}else if(requestArg<responderArg){
				return router().addRule(ruleFactory.apply(createRouterHandlerRequestResponder(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}else {
				return router().addRule(ruleFactory.apply(createRouterHandlerResponderRequest(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}
		}else {
			if(responderArg>0) {
				throw new RuntimeException("QHttpServerResponder unexpected for suppliers.");
			...
			if(requestArg==-1) {
				return router().addRule(ruleFactory.apply(createRouterHandler(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}else {
				return router().addRule(ruleFactory.apply(createRouterHandlerRequest(viewHandler, info.slotInvoker, metaTypes)), metaTypes);
			}
		}
    }
    
    @io.qt.QtUninvokable
    public <ViewHandler extends io.qt.core.QMetaObject.AbstractSlot> boolean route(String pathPattern, io.qt.httpserver.QHttpServerRequest.Methods methods, ViewHandler viewHandler) {
		InvokableTypeInfo<ViewHandler> info = type(viewHandler);
    	if(info.slotInvoker==null)
    		return false;
		java.lang.reflect.Parameter[] parameters = info.parameters;
...
class QHttpServerRouter___{
	...
	boolean addRule(QHttpServerRouterRule rule, io.qt.core.QList<io.qt.core.QMetaType> metaTypes){
		return addRuleImpl(QtJambi_LibraryUtilities.internal.nativeId(this), QtJambi_LibraryUtilities.internal.checkedNativeId(rule), QtJambi_LibraryUtilities.internal.checkedNativeId(metaTypes));
	}
...
class QHttpServerResponder___{
    ...
    @io.qt.QtUninvokable
    public final void write(io.qt.core.QIODevice data, String mimeType, io.qt.httpserver.QHttpServerResponder.StatusCode status){
    ...
    @io.qt.QtUninvokable
    public final void write(io.qt.core.QByteArray data, String mimeType, io.qt.httpserver.QHttpServerResponder.StatusCode status){
    	write(data, io.qt.core.QString.toUtf8(mimeType), status);
    }
	...
	@io.qt.QtUninvokable
    public final void writeStatusLine(io.qt.core.QPair<java.lang.Byte, java.lang.Byte> version){
    	writeStatusLine(io.qt.httpserver.QHttpServerResponder.StatusCode.Ok, version);
    }
    
    @io.qt.QtUninvokable
    public final void writeStatusLine(io.qt.httpserver.QHttpServerResponder.StatusCode status){
    	writeStatusLine(status, new io.qt.core.QPair<>((byte)1, (byte)1));
    }
    
    @io.qt.QtUninvokable
    public final void writeStatusLine(){
    	writeStatusLine(io.qt.httpserver.QHttpServerResponder.StatusCode.Ok, new io.qt.core.QPair<>((byte)1, (byte)1));
    }
	
	@SafeVarargs
	@io.qt.QtUninvokable
    public final io.qt.core.QPair<io.qt.core.QByteArray,io.qt.core.QByteArray>[] headerList(io.qt.core.QPair<io.qt.core.QByteArray,io.qt.core.QByteArray>... pairs){
    	return pairs;
    }
	
	@SafeVarargs
	@io.qt.QtUninvokable
    public final void write(io.qt.core.QByteArray data, io.qt.core.QPair<io.qt.core.QByteArray,io.qt.core.QByteArray>... headers){
        write(data, headers, io.qt.httpserver.QHttpServerResponder.StatusCode.Ok);
    }
	
	@SafeVarargs
	@io.qt.QtUninvokable
    public final void write(io.qt.core.QIODevice data, io.qt.core.QPair<io.qt.core.QByteArray,io.qt.core.QByteArray>... headers){
        write(data, headers, io.qt.httpserver.QHttpServerResponder.StatusCode.Ok);
    }
	
	@SafeVarargs
	@io.qt.QtUninvokable
    public final void write(io.qt.core.QJsonDocument document, io.qt.core.QPair<io.qt.core.QByteArray,io.qt.core.QByteArray>... headers){
