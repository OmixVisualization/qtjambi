...
class QTest__{
    ...
    public static <T extends Comparable<T>> void QCOMPARE(T t1, T t2) throws AssertionError {
        InvocationInfo info = invocationInfoProvider().apply(3);
    ...
    @io.qt.QtUninvokable
    private static void QTRY_TIMEOUT_DEBUG_IMPL(InvocationInfo info, java.util.function.BooleanSupplier expr, int timeoutValue, int step) throws AssertionError {
        if (!(expr.getAsBoolean())) {
    ...
    @io.qt.QtUninvokable
    private static void QTRY_IMPL(InvocationInfo info, java.util.function.BooleanSupplier expr, int timeout) throws AssertionError {
    ...
    @io.qt.QtUninvokable
    private static void QTRY_COMPARE_WITH_TIMEOUT_IMPL(InvocationInfo info, java.util.function.BooleanSupplier expr, java.util.function.BooleanSupplier equals, int timeout) throws AssertionError {
        int qt_test_step = timeout < 350 ? timeout / 7 + 1 : 50;
        int qt_test_timeoutValue = timeout;
        { 
            QTRY_LOOP_IMPL(()->currentTestFailed() || (expr.getAsBoolean()), qt_test_timeoutValue, qt_test_step); 
    ...
    @io.qt.QtUninvokable
    private static void QVERIFY(InvocationInfo info, java.util.function.BooleanSupplier statement) throws AssertionError {
    ...
    @io.qt.QtUninvokable
    private static void QVERIFY(InvocationInfo info, java.util.function.BooleanSupplier statement, String description) throws AssertionError {
...
class QTest_5__{
    ...
    @io.qt.QtUninvokable
    public static io.qt.test.QTest.QTouchEventSequence touchEvent(io.qt.gui.QWindow window, io.qt.gui.QTouchDevice device, boolean autoCommit){
        return touchEvent(nativeId(window), nativeId(device), autoCommit, false);
    }
    @io.qt.QtUninvokable
    ...
    @io.qt.QtUninvokable
    public static io.qt.test.QTest.QTouchEventSequence touchEvent(io.qt.widgets.QWidget window, io.qt.gui.QTouchDevice device, boolean autoCommit){
        return touchEvent(nativeId(window), nativeId(device), autoCommit, true);
    }
    
    @io.qt.QtUninvokable
    private static native io.qt.test.QTest.QTouchEventSequence touchEvent(long windowId, long deviceId, boolean autoCommit, boolean isWidget);
...
class QTest_6__{
    ...
    @io.qt.QtUninvokable
    public static io.qt.test.QTest.QTouchEventWidgetSequence touchEvent(io.qt.widgets.QWidget window, io.qt.gui.QPointingDevice device, boolean autoCommit){
        return touchEvent(nativeId(window), nativeId(device), autoCommit);
    }
    
    @io.qt.QtUninvokable
    private static native io.qt.test.QTest.QTouchEventWidgetSequence touchEvent(long windowId, long deviceId, boolean autoCommit);
...
class QSignalSpy__{
    ...
    public QSignalSpy(QMetaObject.AbstractSignal signal) {
        ...
        __qt_QSignalSpy_new_const_QObject_ptr_cref_QMetaMethod(this, obj, signalMethod);
    }
    
    private io.qt.core.QList<io.qt.core.QList<Object>> list;
    
    @io.qt.QtUninvokable
    private io.qt.core.QList<io.qt.core.QList<Object>> list(){
        if(list==null || list.isDisposed()) {
            list = list(nativeId(this));
        }
        return list;
    }
    
    @io.qt.QtUninvokable
    private static native io.qt.core.QList<io.qt.core.QList<Object>> list(long nativeId);

    @io.qt.QtUninvokable
    public final void forEach(Consumer<? super QList<Object>> action) {
        list().forEach(action);
    }

    @io.qt.QtUninvokable
    public boolean addAll(Collection<? extends QList<Object>> c) {
        return list().addAll(c);
    }

    @io.qt.QtUninvokable
    public boolean addAll(int index, Collection<? extends QList<Object>> c) {
        return list().addAll(index, c);
    }

    @io.qt.QtUninvokable
    public QList<Object> remove(int index) {
        return list().remove(index);
    }

    @io.qt.QtUninvokable
    public ListIterator<QList<Object>> listIterator() {
        return list().listIterator();
    }

    @io.qt.QtUninvokable
    public ListIterator<QList<Object>> listIterator(int index) {
        return list().listIterator(index);
    }

    @io.qt.QtUninvokable
    public List<QList<Object>> subList(int fromIndex, int toIndex) {
    ...
    @io.qt.QtUninvokable
    public QList<QList<Object>> clone() {
        return list().clone();
    }

    @io.qt.QtUninvokable
    public final void append(Collection<QList<Object>> t) {
        list().append(t);
    }
    ...
    @io.qt.QtUninvokable
    public final void append(QList<Object> t) {
        list().append(t);
    }

    @io.qt.QtUninvokable
    public Iterator<QList<Object>> iterator() {
    ...
    @io.qt.QtUninvokable
    public final QList<Object> at(int i) {
        return list().at(i);
    }
    ...
    @io.qt.QtUninvokable
    public final int count(QList<Object> t) {
        return list().count(t);
    }

    @io.qt.QtUninvokable
    public final boolean endsWith(QList<Object> t) {
        return list().endsWith(t);
    }

    @io.qt.QtUninvokable
    public final QList<Object> first() {
        return list().first();
    }

    @io.qt.QtUninvokable
    public final int indexOf(QList<Object> t, int from) {
        return list().indexOf(t, from);
    }

    @io.qt.QtUninvokable
    public final void insert(int i, QList<Object> t) {
        list().insert(i, t);
    }
    ...
    @io.qt.QtUninvokable
    public final QList<Object> last() {
        return list().last();
    }
    ...
    @io.qt.QtUninvokable
    public final int lastIndexOf(QList<Object> t, int from) {
    ...
    @io.qt.QtUninvokable
    public final QList<QList<Object>> mid(int pos) {
        return list().mid(pos);
    }

    @io.qt.QtUninvokable
    public final QList<QList<Object>> mid(int pos, int length) {
    ...
    @io.qt.QtUninvokable
    public final void prepend(QList<Object> t) {
        list().prepend(t);
    }

    @io.qt.QtUninvokable
    public final int removeAll(QList<Object> t) {
    ...
    @io.qt.QtUninvokable
    public final boolean removeOne(QList<Object> t) {
        return list().removeOne(t);
    }

    @io.qt.QtUninvokable
    public final void replace(int i, QList<Object> t) {
        list().replace(i, t);
    }
    ...
    @io.qt.QtUninvokable
    public final boolean startsWith(QList<Object> t) {
        return list().startsWith(t);
    }

    @io.qt.QtUninvokable
    public final QList<Object> takeAt(int i) {
        return list().takeAt(i);
    }

    @io.qt.QtUninvokable
    public final QList<Object> takeFirst() {
        return list().takeFirst();
    }

    @io.qt.QtUninvokable
    public final QList<Object> takeLast() {
        return list().takeLast();
    }

    @io.qt.QtUninvokable
    public final QList<Object> value(int i) {
        return list().value(i);
    }

    @io.qt.QtUninvokable
    public final QList<Object> value(int i, QList<Object> defaultValue) {
    ...
    @io.qt.QtUninvokable
    public boolean add(QList<Object> e) {
        return list().add(e);
    }

    @io.qt.QtUninvokable
    public void add(int index, QList<Object> e) {
        list().add(index, e);
    }

    @io.qt.QtUninvokable
    public QList<Object> set(int index, QList<Object> e) {
    ...
    @io.qt.QtUninvokable
    public QList<Object> get(int index) {
    ...
    @io.qt.QtUninvokable
    public final void replaceAll(UnaryOperator<QList<Object>> operator) {
    ...
    @io.qt.QtUninvokable
    public final void sort(Comparator<? super QList<Object>> c) {
        list().sort(c);
    }

    @io.qt.QtUninvokable
    public final boolean removeIf(Predicate<? super QList<Object>> filter) {
        return list().removeIf(filter);
    }

    @io.qt.QtUninvokable
    public final Spliterator<QList<Object>> spliterator() {
        return list().spliterator();
    }

    @io.qt.QtUninvokable
    public final Stream<QList<Object>> stream() {
        return list().stream();
    }

    @io.qt.QtUninvokable
    public final Stream<QList<Object>> parallelStream() {
...
class QSignalSpy_5_{
    @io.qt.QtUninvokable
    public final QSet<QList<Object>> toSet()    {
        return list().toSet();
    }
}// class
...
class QSignalSpy_6_{
    @io.qt.QtUninvokable
    public final void fill(QList<Object> t) {
        list().fill(t);
    }

    @io.qt.QtUninvokable
    public final void fill(QList<Object> t, int size) {
        list().fill(t, size);
    }

    @io.qt.QtUninvokable
    public final void insert(int i, int n, QList<Object> t) {
        list().insert(i, n, t);
    }
