...
class QtConcurrent___ extends QtConcurrent {
     ...
     * Note: This function will block until all items in the sequence have been processed.
     */
    public native static <T> void blockingFilter(java.util.Collection<T> sequence, FilteredFunctor<T> filteredFunctor);    
    ...
    private native static QFutureVoid runVoid2(QThreadPool threadPool, Runnable runnable);
}// class
