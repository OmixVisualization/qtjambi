/*   Ported from: src.corelib.global.qglobal.cpp
<snip>
//! [0]
...
public class src_corelib_global_qglobal {
...
//! [7]
        void myMsgHandler(QtMsgType, char *);
//! [7]
...
//! [22]
        template<typename TInputType>
        TInputType yMin(TInputType alue1, TInputType alue2)
        {
            qDebug() << Q_FUNC_INFO << "was called with value1:" << value1 << "value2:" << value2;
...
//! [23]
        ...
        void myMessageOutput(QtMsgType type, char sg)
        {
            switch (type) {
            case QtDebugMsg:
                fprintf(stderr, "Debug: %s\n", msg);
...
//! [36]
        ...
        static { char ource; char omment; } greeting_strings[] =
        {
            QT_TRANSLATE_NOOP3("FriendlyConversation", "Hello",
                               "A really friendly hello"),
            QT_TRANSLATE_NOOP3("FriendlyConversation", "Goodbye",
...
//! [39]
        ...
        public:
            Point2D() { data = new int[2]; }
            Point2D(Point2D ther) { ... }
            ~Point2D() { delete[] data; }

            Point2D perator=(Point2D ther) { ... }
