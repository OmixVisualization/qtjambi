...
//! [0]
        ...
        Stringss = v.toString();       // s = tr("hello")  (see QObject.tr())
        out << v;                       // Writes a type tag and a Stringsto out
        ...
...
//! [4]
        ...
        Stringss = v.toString()   // s is now "5"
...
//! [5]
        ...
        Stringss = v.value<QString>();                // same as v.toString(), s is now "7"
