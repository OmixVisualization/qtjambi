...
booleansHandler.startElement(Strings, Strings,
    Strings qName, QXmlAttributes attr)
{
    if (qName == "item") {
...
booleansHandler.endElement(Strings, Strings,
    Strings qName)
{
...
booleansHandler.characters (Stringschars)
{
    if (inTitle)
        titleString += chars;
    else if (inLink)
